 ...
 */
namespace TenantCloud\BetterReflection\Relocated\Evenement\Tests;

use TenantCloud\BetterReflection\Relocated\Evenement\EventEmitter;
use InvalidArgumentException;
use TenantCloud\BetterReflection\Relocated\PHPUnit\Framework\TestCase;
class EventEmitterTest extends \TenantCloud\BetterReflection\Relocated\PHPUnit\Framework\TestCase
{
    private $emitter;
    public function setUp()
    {
        $this->emitter = new \TenantCloud\BetterReflection\Relocated\Evenement\EventEmitter();
    }
    ...
    {
        $listener = new \TenantCloud\BetterReflection\Relocated\Evenement\Tests\Listener();
        $this->emitter->on('foo', [$listener, 'onFoo']);
    }
    public function testAddListenerWithStaticMethod()
    {
        $this->emitter->on('bar', ['TenantCloud\\BetterReflection\\Relocated\\Evenement\\Tests\\Listener', 'onBar']);
    }
    ...
    public function testCallablesStaticClass()
    {
        ...
        $this->emitter->emit('foo', ['bar']);
        self::assertSame(['bar'], \TenantCloud\BetterReflection\Relocated\Evenement\Tests\Listener::getStaticData());
    }
    public function testCallablesFunction()
    {
        $this->emitter->on('foo', 'TenantCloud\\BetterReflection\\Relocated\\Evenement\\Tests\\setGlobalTestData');
        $this->emitter->emit('foo', ['bar']);
