 ...
 */
class Uri implements \TenantCloud\BetterReflection\Relocated\Psr\Http\Message\UriInterface
{
     ...
     * @return UriInterface
     */
    public static function resolve(\TenantCloud\BetterReflection\Relocated\Psr\Http\Message\UriInterface $base, $rel)
    {
        if ($rel === null || $rel === '') {
            return $base;
        }
        if (!$rel instanceof \TenantCloud\BetterReflection\Relocated\Psr\Http\Message\UriInterface) {
            $rel = new self($rel);
        }
     ...
     * @return UriInterface
     */
    public static function withoutQueryValue(\TenantCloud\BetterReflection\Relocated\Psr\Http\Message\UriInterface $uri, $key)
    {
     ...
     * @return UriInterface
     */
    public static function withQueryValue(\TenantCloud\BetterReflection\Relocated\Psr\Http\Message\UriInterface $uri, $key, $value)
    {
        $current = $uri->getQuery();
