 ...
 */
class FnStream implements \TenantCloud\BetterReflection\Relocated\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\TenantCloud\BetterReflection\Relocated\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
