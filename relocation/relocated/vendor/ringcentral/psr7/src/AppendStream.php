 ...
 */
class AppendStream implements \TenantCloud\BetterReflection\Relocated\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\TenantCloud\BetterReflection\Relocated\Psr\Http\Message\StreamInterface $stream)
    {
