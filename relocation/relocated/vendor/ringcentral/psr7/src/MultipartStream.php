 ...
 */
class MultipartStream extends \TenantCloud\BetterReflection\Relocated\RingCentral\Psr7\StreamDecoratorTrait implements \TenantCloud\BetterReflection\Relocated\Psr\Http\Message\StreamInterface
{
    private $boundary;
    /**
    ...
    {
        $stream = new \TenantCloud\BetterReflection\Relocated\RingCentral\Psr7\AppendStream();
    ...
    private function addElement(\TenantCloud\BetterReflection\Relocated\RingCentral\Psr7\AppendStream $stream, array $element)
    {
