...
use TenantCloud\BetterReflection\Relocated\RingCentral\Psr7\StreamWrapper;
use TenantCloud\BetterReflection\Relocated\RingCentral\Psr7;
/**
 * @covers RingCentral\Psr7\StreamWrapper
 */
class StreamWrapperTest extends \TenantCloud\BetterReflection\Relocated\PHPUnit_Framework_TestCase
{
    public function testResource()
    {
        $stream = \TenantCloud\BetterReflection\Relocated\RingCentral\Psr7\stream_for('foo');
        $handle = \TenantCloud\BetterReflection\Relocated\RingCentral\Psr7\StreamWrapper::getResource($stream);
    ...
    {
        $stream = $this->getMockBuilder('TenantCloud\\BetterReflection\\Relocated\\Psr\\Http\\Message\\StreamInterface')->setMethods(array('isReadable', 'isWritable'))->getMockForAbstractClass();
        ...
        \TenantCloud\BetterReflection\Relocated\RingCentral\Psr7\StreamWrapper::getResource($stream);
    }
    /**
    ...
    public function testCanOpenReadonlyStream()
    {
        ...
        $r = \TenantCloud\BetterReflection\Relocated\RingCentral\Psr7\StreamWrapper::getResource($stream);
