...
use TenantCloud\BetterReflection\Relocated\RingCentral\Psr7\ServerRequest;
class ServerRequestTest extends \TenantCloud\BetterReflection\Relocated\PHPUnit_Framework_TestCase
{
    private $request;
    public function setUp()
    {
        $this->request = new \TenantCloud\BetterReflection\Relocated\RingCentral\Psr7\ServerRequest('GET', 'http://localhost');
    }
