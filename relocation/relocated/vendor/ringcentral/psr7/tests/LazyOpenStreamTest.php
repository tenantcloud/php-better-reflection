...
use TenantCloud\BetterReflection\Relocated\RingCentral\Psr7\LazyOpenStream;
class LazyOpenStreamTest extends \TenantCloud\BetterReflection\Relocated\PHPUnit_Framework_TestCase
{
    private $fname;
    public function setup()
    {
        $this->fname = \tempnam('/tmp', 'tfile');
    ...
    {
        $l = new \TenantCloud\BetterReflection\Relocated\RingCentral\Psr7\LazyOpenStream($this->fname, 'w+');
        $l->write('foo');
    ...
    public function testProxiesToFile()
    {
        ...
        $l = new \TenantCloud\BetterReflection\Relocated\RingCentral\Psr7\LazyOpenStream($this->fname, 'r');
