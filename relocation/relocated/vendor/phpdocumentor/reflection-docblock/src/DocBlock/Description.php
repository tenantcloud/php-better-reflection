...
use TenantCloud\BetterReflection\Relocated\phpDocumentor\Reflection\DocBlock\Tags\Formatter\PassthroughFormatter;
...
class Description
{
    ...
    {
        \TenantCloud\BetterReflection\Relocated\Webmozart\Assert\Assert::string($bodyTemplate);
