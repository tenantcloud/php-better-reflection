 ...
 */
final class Example extends \TenantCloud\BetterReflection\Relocated\phpDocumentor\Reflection\DocBlock\Tags\BaseTag implements \TenantCloud\BetterReflection\Relocated\phpDocumentor\Reflection\DocBlock\Tags\Factory\StaticMethod
{
    /**
    ...
    {
        \TenantCloud\BetterReflection\Relocated\Webmozart\Assert\Assert::notEmpty($filePath);
        \TenantCloud\BetterReflection\Relocated\Webmozart\Assert\Assert::integer($startingLine);
        \TenantCloud\BetterReflection\Relocated\Webmozart\Assert\Assert::greaterThanEq($startingLine, 0);
