 ...
 */
abstract class AggregatedType implements \TenantCloud\BetterReflection\Relocated\phpDocumentor\Reflection\Type, \IteratorAggregate
{
    /**
     ...
     */
    public function get(int $index) : ?\TenantCloud\BetterReflection\Relocated\phpDocumentor\Reflection\Type
    {
        if (!$this->has($index)) {
            return null;
        }
     ...
     */
    public function contains(\TenantCloud\BetterReflection\Relocated\phpDocumentor\Reflection\Type $type) : bool
    {
     ...
     */
    private function add(\TenantCloud\BetterReflection\Relocated\phpDocumentor\Reflection\Type $type) : void
    {
