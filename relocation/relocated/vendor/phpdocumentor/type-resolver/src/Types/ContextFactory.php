...
final class ContextFactory
{
     ...
     */
    public function createFromReflector(\Reflector $reflector) : \TenantCloud\BetterReflection\Relocated\phpDocumentor\Reflection\Types\Context
    {
    ...
    private function createFromReflectionParameter(\ReflectionParameter $parameter) : \TenantCloud\BetterReflection\Relocated\phpDocumentor\Reflection\Types\Context
    {
    ...
    private function createFromReflectionMethod(\ReflectionMethod $method) : \TenantCloud\BetterReflection\Relocated\phpDocumentor\Reflection\Types\Context
    {
        //phpcs:ignore SlevomatCodingStandard.Commenting.InlineDocCommentDeclaration.MissingVariable
        /** @var ReflectionClass<object> $class */
    ...
    private function createFromReflectionProperty(\ReflectionProperty $property) : \TenantCloud\BetterReflection\Relocated\phpDocumentor\Reflection\Types\Context
    {
        //phpcs:ignore SlevomatCodingStandard.Commenting.InlineDocCommentDeclaration.MissingVariable
        /** @var ReflectionClass<object> $class */
    ...
    private function createFromReflectionClassConstant(\ReflectionClassConstant $constant) : \TenantCloud\BetterReflection\Relocated\phpDocumentor\Reflection\Types\Context
    {
        //phpcs:ignore SlevomatCodingStandard.Commenting.InlineDocCommentDeclaration.MissingVariable
        /** @var ReflectionClass<object> $class */
     ...
     */
    private function createFromReflectionClass(\ReflectionClass $class) : \TenantCloud\BetterReflection\Relocated\phpDocumentor\Reflection\Types\Context
    {
        ...
        return new \TenantCloud\BetterReflection\Relocated\phpDocumentor\Reflection\Types\Context($namespace, []);
    }
    /**
     ...
     */
    public function createForNamespace(string $namespace, string $fileContents) : \TenantCloud\BetterReflection\Relocated\phpDocumentor\Reflection\Types\Context
    {
        ...
        return new \TenantCloud\BetterReflection\Relocated\phpDocumentor\Reflection\Types\Context($namespace, $useStatements);
    }
    /**
