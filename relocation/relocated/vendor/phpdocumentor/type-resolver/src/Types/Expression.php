 ...
 * @psalm-immutable
 */
final class Expression implements \TenantCloud\BetterReflection\Relocated\phpDocumentor\Reflection\Type
{
    /** @var Type */
    protected $valueType;
    /**
     ...
     */
    public function __construct(\TenantCloud\BetterReflection\Relocated\phpDocumentor\Reflection\Type $valueType)
    {
