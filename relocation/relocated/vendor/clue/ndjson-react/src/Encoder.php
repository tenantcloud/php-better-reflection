 ...
 */
class Encoder extends \TenantCloud\BetterReflection\Relocated\Evenement\EventEmitter implements \TenantCloud\BetterReflection\Relocated\React\Stream\WritableStreamInterface
{
    private $output;
    private $options;
    private $depth;
     ...
     */
    public function __construct(\TenantCloud\BetterReflection\Relocated\React\Stream\WritableStreamInterface $output, $options = 0, $depth = 512)
    {
