...
final class Processor
{
     ...
     */
    public function process(\TenantCloud\BetterReflection\Relocated\Nette\Schema\Schema $schema, $data)
    {
        $this->createContext();
     ...
     * @throws ValidationException
     */
    public function processMultiple(\TenantCloud\BetterReflection\Relocated\Nette\Schema\Schema $schema, array $dataset)
    {
        $this->createContext();
        $flatten = null;
        $first = \true;
    ...
    private function throwsErrors() : void
    {
        if ($this->context->errors) {
            throw new \TenantCloud\BetterReflection\Relocated\Nette\Schema\ValidationException(null, $this->context->errors);
        }
    }
    private function createContext()
    {
        $this->context = new \TenantCloud\BetterReflection\Relocated\Nette\Schema\Context();
