...
final class Helpers
{
    ...
    {
        return (new \TenantCloud\BetterReflection\Relocated\Nette\PhpGenerator\Dumper())->dump($var);
    }
    /** @deprecated  use Nette\PhpGenerator\Dumper::format() */
    public static function format(string $statement, ...$args) : string
    {
        return (new \TenantCloud\BetterReflection\Relocated\Nette\PhpGenerator\Dumper())->format($statement, ...$args);
    }
    /** @deprecated  use Nette\PhpGenerator\Dumper::format() */
    ...
    {
        return \TenantCloud\BetterReflection\Relocated\Nette\PhpGenerator\Dumper::createObject($class, $props);
    }
}
