...
abstract class Definition
{
    ...
    {
        if ($this->name) {
            throw new \TenantCloud\BetterReflection\Relocated\Nette\InvalidStateException('Name already has been set.');
        }
        $this->name = $name;
        return $this;
    }
    ...
    protected function setType(?string $type)
    {
        ...
        if ($type === null) {
            ...
            throw new \TenantCloud\BetterReflection\Relocated\Nette\InvalidArgumentException("Service '{$this->name}': Class or interface '{$type}' not found.");
        } else {
            $this->type = \TenantCloud\BetterReflection\Relocated\Nette\DI\Helpers::normalizeClass($type);
        }
        return $this;
    }
    ...
    /********************* life cycle ****************d*g**/
    public abstract function resolveType(\TenantCloud\BetterReflection\Relocated\Nette\DI\Resolver $resolver) : void;
    public abstract function complete(\TenantCloud\BetterReflection\Relocated\Nette\DI\Resolver $resolver) : void;
    public abstract function generateMethod(\TenantCloud\BetterReflection\Relocated\Nette\PhpGenerator\Method $method, \TenantCloud\BetterReflection\Relocated\Nette\DI\PhpGenerator $generator) : void;
