...
abstract class IteratorTestCase extends \TenantCloud\BetterReflection\Relocated\PHPUnit\Framework\TestCase
{
    ...
    protected function assertIteratorInForeach(array $expected, \Traversable $iterator)
    {
        ...
        foreach ($iterator as $file) {
            $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Finder\SplFileInfo::class, $file);
