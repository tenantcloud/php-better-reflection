...
class DateComparatorTest extends \TenantCloud\BetterReflection\Relocated\PHPUnit\Framework\TestCase
{
    public function testConstructor()
    {
        try {
            new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Finder\Comparator\DateComparator('foobar');
        ...
        try {
            new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Finder\Comparator\DateComparator('');
            $this->fail('__construct() throws an \\InvalidArgumentException if the test expression is not valid.');
        } catch (\Exception $e) {
            $this->assertInstanceOf(\InvalidArgumentException::class, $e, '__construct() throws an \\InvalidArgumentException if the test expression is not valid.');
        }
    ...
    {
        $c = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Finder\Comparator\DateComparator($test);
        foreach ($match as $m) {
