...
class ChoiceQuestionTest extends \TenantCloud\BetterReflection\Relocated\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $question = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Question\ChoiceQuestion('A question', ['First response', 'Second response', 'Third response', 'Fourth response']);
    ...
    {
        $question = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Question\ChoiceQuestion('A question', ['First response ', ' Second response', '  Third response  ']);
