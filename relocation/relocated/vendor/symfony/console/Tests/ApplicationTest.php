 ...
 */
namespace TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Tests;
...
use TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Event\ConsoleCommandEvent;
...
use TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Exception\NamespaceNotFoundException;
...
use TenantCloud\BetterReflection\Relocated\Symfony\Component\EventDispatcher\EventDispatcher;
class ApplicationTest extends \TenantCloud\BetterReflection\Relocated\PHPUnit\Framework\TestCase
{
     ...
     */
    protected function ensureStaticCommandHelp(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application $application)
    {
    ...
    {
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application('foo', 'bar');
    ...
    public function testAll()
    {
        ...
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Command\HelpCommand::class, $commands['help'], '->all() returns the registered commands');
    ...
    public function testAllWithCommandLoader()
    {
        ...
        $commands = $application->all('foo');
        $this->assertCount(1, $commands, '->all() takes a namespace as its first argument');
        $application->setCommandLoader(new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\CommandLoader\FactoryCommandLoader(['foo:bar1' => function () {
            return new \TenantCloud\BetterReflection\Relocated\Foo1Command();
        }]));
        $commands = $application->all('foo');
        $this->assertCount(2, $commands, '->all() takes a namespace as its first argument');
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\FooCommand::class, $commands['foo:bar'], '->all() returns the registered commands');
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\Foo1Command::class, $commands['foo:bar1'], '->all() returns the registered commands');
    }
    ...
    {
        $code = function (\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputInterface $input, \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Output\OutputInterface $output) {
    ...
    {
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application();
        $application->add($foo = new \TenantCloud\BetterReflection\Relocated\FooCommand());
        $commands = $application->all();
        $this->assertEquals($foo, $commands['foo:bar'], '->add() registers a command');
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application();
        $application->addCommands([$foo = new \TenantCloud\BetterReflection\Relocated\FooCommand(), $foo1 = new \TenantCloud\BetterReflection\Relocated\Foo1Command()]);
        $commands = $application->all();
    ...
    public function testAddCommandWithEmptyConstructor()
    {
        ...
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application();
        $application->add(new \TenantCloud\BetterReflection\Relocated\Foo5Command());
    }
    public function testHasGet()
    {
        ...
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Command\HelpCommand::class, $command, '->get() returns the help command if --help is provided as the input');
    }
    public function testHasGetWithCommandLoader()
    {
        ...
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\Foo1Command::class, $foo1 = $application->get('foo:bar1'), '->get() returns a command by name from the command loader');
    ...
    public function testGetNamespaces()
    {
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application();
        $application->add(new \TenantCloud\BetterReflection\Relocated\FooCommand());
        $application->add(new \TenantCloud\BetterReflection\Relocated\Foo1Command());
    ...
    public function testFindNamespace()
    {
        ...
        $application->add(new \TenantCloud\BetterReflection\Relocated\Foo2Command());
        $this->assertEquals('foo', $application->findNamespace('foo'), '->findNamespace() returns the given namespace if it exists');
    }
    public function testFindNamespaceWithSubnamespaces()
    {
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application();
        $application->add(new \TenantCloud\BetterReflection\Relocated\FooSubnamespaced1Command());
        $application->add(new \TenantCloud\BetterReflection\Relocated\FooSubnamespaced2Command());
    ...
    {
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application();
        $application->add(new \TenantCloud\BetterReflection\Relocated\BarBucCommand());
        $application->add(new \TenantCloud\BetterReflection\Relocated\FooCommand());
        $application->add(new \TenantCloud\BetterReflection\Relocated\Foo2Command());
        $expectedMsg = "The namespace \"f\" is ambiguous.\nDid you mean one of these?\n    foo\n    foo1";
        $this->expectException(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Exception\NamespaceNotFoundException::class);
    ...
    {
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application();
        $application->add(new \TenantCloud\BetterReflection\Relocated\TestAmbiguousCommandRegistering());
        $application->add(new \TenantCloud\BetterReflection\Relocated\TestAmbiguousCommandRegistering2());
    ...
    public function testFind()
    {
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application();
        $application->add(new \TenantCloud\BetterReflection\Relocated\FooCommand());
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\FooCommand::class, $application->find('foo:bar'), '->find() returns a command if its name exists');
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Command\HelpCommand::class, $application->find('h'), '->find() returns a command if its name exists');
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\FooCommand::class, $application->find('f:bar'), '->find() returns a command if the abbreviation for the namespace exists');
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\FooCommand::class, $application->find('f:b'), '->find() returns a command if the abbreviation for the namespace and the command name exist');
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\FooCommand::class, $application->find('a'), '->find() returns a command if the abbreviation exists for an alias');
    }
    public function testFindCaseSensitiveFirst()
    {
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application();
        $application->add(new \TenantCloud\BetterReflection\Relocated\FooSameCaseUppercaseCommand());
        $application->add(new \TenantCloud\BetterReflection\Relocated\FooSameCaseLowercaseCommand());
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\FooSameCaseUppercaseCommand::class, $application->find('f:B'), '->find() returns a command if the abbreviation is the correct case');
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\FooSameCaseUppercaseCommand::class, $application->find('f:BAR'), '->find() returns a command if the abbreviation is the correct case');
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\FooSameCaseLowercaseCommand::class, $application->find('f:b'), '->find() returns a command if the abbreviation is the correct case');
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\FooSameCaseLowercaseCommand::class, $application->find('f:bar'), '->find() returns a command if the abbreviation is the correct case');
    }
    public function testFindCaseInsensitiveAsFallback()
    {
        ...
        $application->add(new \TenantCloud\BetterReflection\Relocated\FooSameCaseLowercaseCommand());
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\FooSameCaseLowercaseCommand::class, $application->find('f:b'), '->find() returns a command if the abbreviation is the correct case');
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\FooSameCaseLowercaseCommand::class, $application->find('f:B'), '->find() will fallback to case insensitivity');
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\FooSameCaseLowercaseCommand::class, $application->find('FoO:BaR'), '->find() will fallback to case insensitivity');
    }
    public function testFindCaseInsensitiveSuggestions()
    {
        ...
        $application->add(new \TenantCloud\BetterReflection\Relocated\FooSameCaseLowercaseCommand());
        $application->add(new \TenantCloud\BetterReflection\Relocated\FooSameCaseUppercaseCommand());
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\FooSameCaseLowercaseCommand::class, $application->find('FoO:BaR'), '->find() will find two suggestions with case insensitivity');
    }
    public function testFindWithCommandLoader()
    {
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application();
        $application->setCommandLoader(new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\CommandLoader\FactoryCommandLoader(['foo:bar' => $f = function () {
            return new \TenantCloud\BetterReflection\Relocated\FooCommand();
        }]));
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\FooCommand::class, $application->find('foo:bar'), '->find() returns a command if its name exists');
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Command\HelpCommand::class, $application->find('h'), '->find() returns a command if its name exists');
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\FooCommand::class, $application->find('f:bar'), '->find() returns a command if the abbreviation for the namespace exists');
    ...
    public function testFindWithAmbiguousAbbreviationsFindsCommandIfAlternativesAreHidden()
    {
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application();
        $application->add(new \TenantCloud\BetterReflection\Relocated\FooCommand());
        $application->add(new \TenantCloud\BetterReflection\Relocated\FooHiddenCommand());
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\FooCommand::class, $application->find('foo:'));
    }
    public function testFindCommandEqualNamespace()
    {
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application();
        $application->add(new \TenantCloud\BetterReflection\Relocated\Foo3Command());
        $application->add(new \TenantCloud\BetterReflection\Relocated\Foo4Command());
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\Foo3Command::class, $application->find('foo3:bar'), '->find() returns the good command even if a namespace has same name');
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\Foo4Command::class, $application->find('foo3:bar:toh'), '->find() returns a command even if its namespace equals another command name');
    }
    public function testFindCommandWithAmbiguousNamespacesButUniqueName()
    {
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application();
        $application->add(new \TenantCloud\BetterReflection\Relocated\FooCommand());
        $application->add(new \TenantCloud\BetterReflection\Relocated\FoobarCommand());
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\FoobarCommand::class, $application->find('f:f'));
    }
    public function testFindCommandWithMissingNamespace()
    {
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application();
        $application->add(new \TenantCloud\BetterReflection\Relocated\Foo4Command());
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\Foo4Command::class, $application->find('f::t'));
    }
    /**
...
', $tester->getDisplay(\true));
    ...
    {
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application();
        $application->add(new \TenantCloud\BetterReflection\Relocated\FooWithoutAliasCommand());
        $application->setAutoExit(\false);
        $tester = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Tester\ApplicationTester($application);
        $tester->setInputs(['y']);
    ...
    public function testFindAlternativeExceptionMessageMultiple()
    {
        ...
        try {
            ...
            $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Exception\CommandNotFoundException::class, $e, '->find() throws a CommandNotFoundException if command does not exist, with alternatives');
        ...
        try {
            ...
            $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Exception\CommandNotFoundException::class, $e);
    ...
    public function testFindAlternativeCommands()
    {
        ...
        try {
            ...
            $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Exception\CommandNotFoundException::class, $e, '->find() throws a CommandNotFoundException if command does not exist');
    ...
    {
        $fooCommand = new \TenantCloud\BetterReflection\Relocated\FooCommand();
        $fooCommand->setAliases(['foo2']);
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application();
        $application->setCommandLoader(new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\CommandLoader\FactoryCommandLoader(['foo3' => static function () use($fooCommand) {
            return $fooCommand;
        }]));
    ...
    public function testFindAlternativeNamespace()
    {
        ...
        try {
            ...
            $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Exception\CommandNotFoundException::class, $e, '->find() throws a CommandNotFoundException if namespace does not exist');
            $this->assertSame([], $e->getAlternatives());
        ...
        try {
            ...
            $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Exception\NamespaceNotFoundException::class, $e, '->find() throws a NamespaceNotFoundException if namespace does not exist');
            $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Exception\CommandNotFoundException::class, $e, 'NamespaceNotFoundException extends from CommandNotFoundException');
    ...
    public function testFindAlternativesOutput()
    {
        ...
        try {
            ...
            $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Exception\CommandNotFoundException::class, $e, '->find() throws a CommandNotFoundException if command is not defined');
    ...
    {
        $application = $this->getMockBuilder(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application::class)->setMethods(['getNamespaces'])->getMock();
    ...
    public function testFindHiddenWithExactName()
    {
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application();
        $application->add(new \TenantCloud\BetterReflection\Relocated\FooHiddenCommand());
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\FooHiddenCommand::class, $application->find('foo:hidden'));
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\FooHiddenCommand::class, $application->find('afoohidden'));
    }
    /**
     * @group legacy
    ...
    public function testFindHiddenWithAbbreviatedName($name)
    {
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application();
        $application->add(new \TenantCloud\BetterReflection\Relocated\FooHiddenCommand());
        $application->add(new \TenantCloud\BetterReflection\Relocated\BarHiddenCommand());
        $application->find($name);
    }
    public function provideAbbreviationsForHiddenCommands()
    {
        return [['foo:hidde'], ['afoohidd'], ['bar:hidde']];
    }
    ...
    public function testRenderException()
    {
        ...
        $tester->run(['command' => 'foo'], ['decorated' => \false, 'verbosity' => \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Output\Output::VERBOSITY_VERBOSE, 'capture_stderr_separately' => \true]);
        ...
        $tester->run(['command' => 'foo3:bar'], ['decorated' => \false, 'verbosity' => \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Output\Output::VERBOSITY_VERBOSE]);
    ...
    {
        $application = $this->getMockBuilder(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application::class)->setMethods(['getTerminalWidth'])->getMock();
        $application->setAutoExit(\false);
    ...
    public function testRenderAnonymousException()
    {
        ...
        $tester = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Tester\ApplicationTester($application);
        $tester->run(['command' => 'foo'], ['decorated' => \false]);
        $this->assertStringContainsString('[InvalidArgumentException@anonymous]', $tester->getDisplay(\true));
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application();
        $application->setAutoExit(\false);
        $application->register('foo')->setCode(function () {
        ...
        $tester = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Tester\ApplicationTester($application);
        $tester->run(['command' => 'foo'], ['decorated' => \false]);
        $this->assertStringContainsString('Dummy type "class@anonymous" is invalid.', $tester->getDisplay(\true));
    }
    ...
    public function testRun()
    {
        ...
        $application->setAutoExit(\false);
        $application->setCatchExceptions(\false);
        $application->add($command = new \TenantCloud\BetterReflection\Relocated\Foo1Command());
        $_SERVER['argv'] = ['cli.php', 'foo:bar1'];
        \ob_start();
        $application->run();
        \ob_end_clean();
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\ArgvInput::class, $command->input, '->run() creates an ArgvInput by default if none is given');
        $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Output\ConsoleOutput::class, $command->output, '->run() creates a ConsoleOutput by default if none is given');
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application();
        $application->setAutoExit(\false);
        $application->setCatchExceptions(\false);
        ...
        $this->assertSame(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Output\Output::VERBOSITY_VERBOSE, $tester->getOutput()->getVerbosity(), '->run() sets the output to verbose if --verbose is passed');
        $tester->run(['command' => 'list', '--verbose' => 1]);
        $this->assertSame(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Output\Output::VERBOSITY_VERBOSE, $tester->getOutput()->getVerbosity(), '->run() sets the output to verbose if --verbose=1 is passed');
        $tester->run(['command' => 'list', '--verbose' => 2]);
        $this->assertSame(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Output\Output::VERBOSITY_VERY_VERBOSE, $tester->getOutput()->getVerbosity(), '->run() sets the output to very verbose if --verbose=2 is passed');
        $tester->run(['command' => 'list', '--verbose' => 3]);
        $this->assertSame(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Output\Output::VERBOSITY_DEBUG, $tester->getOutput()->getVerbosity(), '->run() sets the output to debug if --verbose=3 is passed');
        $tester->run(['command' => 'list', '--verbose' => 4]);
        $this->assertSame(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Output\Output::VERBOSITY_VERBOSE, $tester->getOutput()->getVerbosity(), '->run() sets the output to verbose if unknown --verbose level is passed');
        $tester->run(['command' => 'list', '-v' => \true]);
        $this->assertSame(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Output\Output::VERBOSITY_VERBOSE, $tester->getOutput()->getVerbosity(), '->run() sets the output to verbose if -v is passed');
        $tester->run(['command' => 'list', '-vv' => \true]);
        $this->assertSame(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Output\Output::VERBOSITY_VERY_VERBOSE, $tester->getOutput()->getVerbosity(), '->run() sets the output to verbose if -v is passed');
        $tester->run(['command' => 'list', '-vvv' => \true]);
        $this->assertSame(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Output\Output::VERBOSITY_DEBUG, $tester->getOutput()->getVerbosity(), '->run() sets the output to verbose if -v is passed');
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application();
        $application->setAutoExit(\false);
        $application->setCatchExceptions(\false);
        $application->add(new \TenantCloud\BetterReflection\Relocated\FooCommand());
    ...
    public function testRunWithGlobalOptionAndNoCommand()
    {
        ...
        $application->setAutoExit(\false);
        $application->setCatchExceptions(\false);
        $application->getDefinition()->addOption(new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputOption('foo', 'f', \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputOption::VALUE_OPTIONAL));
        $output = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Output\StreamOutput(\fopen('php://memory', 'w', \false));
        $input = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\ArgvInput(['cli.php', '--foo', 'bar']);
    ...
    public function testVerboseValueNotBreakArguments()
    {
        ...
        $application->add(new \TenantCloud\BetterReflection\Relocated\FooCommand());
        $output = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Output\StreamOutput(\fopen('php://memory', 'w', \false));
        $input = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\ArgvInput(['cli.php', '-v', 'foo:bar']);
        $application->run($input, $output);
        $this->addToAssertionCount(1);
        $input = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\ArgvInput(['cli.php', '--verbose', 'foo:bar']);
        $application->run($input, $output);
        $this->addToAssertionCount(1);
    }
    public function testRunReturnsIntegerExitCode()
    {
        ...
        $application = $this->getMockBuilder(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application::class)->setMethods(['doRun'])->getMock();
        $application->setAutoExit(\false);
        $application->expects($this->once())->method('doRun')->willThrowException($exception);
        $exitCode = $application->run(new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\ArrayInput([]), new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Output\NullOutput());
    ...
    public function testRunDispatchesIntegerExitCode()
    {
        ...
        $dispatcher = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\EventDispatcher\EventDispatcher();
        $dispatcher->addListener('console.terminate', function (\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Event\ConsoleTerminateEvent $event) use(&$passedRightValue) {
            $passedRightValue = 4 === $event->getExitCode();
        });
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application();
        $application->setDispatcher($dispatcher);
        $application->setAutoExit(\false);
        $application->register('test')->setCode(function (\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputInterface $input, \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Output\OutputInterface $output) {
    ...
    public function testAddingOptionWithDuplicateShortcut()
    {
        ...
        $application->setCatchExceptions(\false);
        $application->setDispatcher($dispatcher);
        $application->getDefinition()->addOption(new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputOption('--env', '-e', \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Environment'));
        $application->register('foo')->setAliases(['f'])->setDefinition([new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputOption('survey', 'e', \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'My option with a shortcut.')])->setCode(function (\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputInterface $input, \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Output\OutputInterface $output) {
        });
        $input = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\ArrayInput(['command' => 'foo']);
    ...
    public function testAddingAlreadySetDefinitionElementData($def)
    {
        ...
        $application->setAutoExit(\false);
        $application->setCatchExceptions(\false);
        $application->register('foo')->setDefinition([$def])->setCode(function (\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputInterface $input, \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Output\OutputInterface $output) {
        });
        $input = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\ArrayInput(['command' => 'foo']);
        $output = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Output\NullOutput();
        $application->run($input, $output);
    ...
    {
        return [[new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputArgument('command', \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputArgument::REQUIRED)], [new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputOption('quiet', '', \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputOption::VALUE_NONE)], [new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputOption('query', 'q', \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputOption::VALUE_NONE)]];
    }
    ...
    public function testAddingSingleHelperSetOverwritesDefaultValues()
    {
        ...
        $application->setAutoExit(\false);
        $application->setCatchExceptions(\false);
        $application->setHelperSet(new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Helper\HelperSet([new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Helper\FormatterHelper()]));
        $helperSet = $application->getHelperSet();
        $this->assertTrue($helperSet->has('formatter'));
    ...
    {
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Tests\CustomApplication();
        $application->setAutoExit(\false);
        $application->setCatchExceptions(\false);
        $application->setHelperSet(new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Helper\HelperSet([new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Helper\FormatterHelper()]));
        $helperSet = $application->getHelperSet();
    ...
    public function testSettingCustomInputDefinitionOverwritesDefaultValues()
    {
        ...
        $application->setAutoExit(\false);
        $application->setCatchExceptions(\false);
        $application->setDefinition(new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputDefinition([new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputOption('--custom', '-c', \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Set the custom input definition.')]));
        $inputDefinition = $application->getDefinition();
        // check whether the default arguments and options are not returned any more
        $this->assertFalse($inputDefinition->hasArgument('command'));
        $this->assertFalse($inputDefinition->hasOption('help'));
    ...
    public function testRunWithDispatcher()
    {
        ...
        $application->register('foo')->setCode(function (\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputInterface $input, \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Output\OutputInterface $output) {
            $output->write('foo.');
        });
        $tester = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Tester\ApplicationTester($application);
    ...
    public function testRunWithError()
    {
        ...
        $application->setAutoExit(\false);
        $application->setCatchExceptions(\false);
        $application->register('dym')->setCode(function (\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputInterface $input, \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Output\OutputInterface $output) {
            $output->write('dym.');
    ...
    {
        $dispatcher = $this->getDispatcher();
        $dispatcher->addListener('console.error', function (\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Event\ConsoleErrorEvent $event) {
        ...
        $this->assertEquals(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Event\ConsoleCommandEvent::RETURN_CODE_DISABLED, $tester->getStatusCode());
    }
    public function testConsoleErrorEventIsTriggeredOnCommandNotFound()
    {
        ...
        $dispatcher->addListener('console.error', function (\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Event\ConsoleErrorEvent $event) {
            ...
            $this->assertInstanceOf(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Exception\CommandNotFoundException::class, $event->getError());
    ...
    public function testErrorIsRethrownIfNotHandledByConsoleErrorEvent()
    {
        ...
        $application->setAutoExit(\false);
        $application->setCatchExceptions(\false);
        $application->setDispatcher(new \TenantCloud\BetterReflection\Relocated\Symfony\Component\EventDispatcher\EventDispatcher());
    ...
    public function testRunWithErrorFailingStatusCode()
    {
        ...
        $application->setDispatcher($this->getDispatcher());
        $application->setAutoExit(\false);
        $application->register('dus')->setCode(function (\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputInterface $input, \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Output\OutputInterface $output) {
            $output->write('dus.');
    ...
    public function testRunWithDispatcherSkippingCommand()
    {
        ...
        $this->assertEquals(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Event\ConsoleCommandEvent::RETURN_CODE_DISABLED, $exitCode);
    }
    public function testRunWithDispatcherAccessingInputOptions()
    {
        ...
        $quietValue = null;
        $dispatcher = $this->getDispatcher();
        $dispatcher->addListener('console.command', function (\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Event\ConsoleCommandEvent $event) use(&$noInteractionValue, &$quietValue) {
    ...
    public function testRunWithDispatcherAddingInputOptions()
    {
        $extraValue = null;
        $dispatcher = $this->getDispatcher();
        $dispatcher->addListener('console.command', function (\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Event\ConsoleCommandEvent $event) use(&$extraValue) {
            $definition = $event->getCommand()->getDefinition();
            $input = $event->getInput();
            $definition->addOption(new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputOption('extra', null, \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED));
    ...
    {
        $command = new \TenantCloud\BetterReflection\Relocated\FooCommand();
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application();
        $application->setAutoExit(\false);
        ...
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Tests\CustomDefaultCommandApplication();
        $application->setAutoExit(\false);
        $tester = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Tester\ApplicationTester($application);
        $tester->run([], ['interactive' => \false]);
        $this->assertEquals('called' . \PHP_EOL, $tester->getDisplay(), 'Application runs the default set command if different from \'list\' command');
    ...
    {
        $command = new \TenantCloud\BetterReflection\Relocated\FooOptCommand();
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application();
        $application->setAutoExit(\false);
        $application->add($command);
        $application->setDefaultCommand($command->getName());
    ...
    public function testRunLazyCommandService()
    {
        ...
        $container->addCompilerPass(new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\DependencyInjection\AddConsoleCommandPass());
        $container->register('lazy-command', \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Tests\LazyCommand::class)->addTag('console.command', ['command' => 'lazy:command'])->addTag('console.command', ['command' => 'lazy:alias'])->addTag('console.command', ['command' => 'lazy:alias2']);
        $container->compile();
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application();
    ...
    public function testGetDisabledLazyCommand()
    {
        $this->expectException(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Exception\CommandNotFoundException::class);
        $application = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application();
        $application->setCommandLoader(new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\CommandLoader\FactoryCommandLoader(['disabled' => function () {
            return new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Tests\DisabledCommand();
        }]));
    ...
    public function testFindAlternativesDoesNotLoadSameNamespaceCommandsOnExactMatch()
    {
        ...
        $application->setAutoExit(\false);
        $loaded = [];
        $application->setCommandLoader(new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\CommandLoader\FactoryCommandLoader(['foo:bar' => function () use(&$loaded) {
            $loaded['foo:bar'] = \true;
            return (new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Command\Command('foo:bar'))->setCode(function () {
            });
        }, 'foo' => function () use(&$loaded) {
            $loaded['foo'] = \true;
            return (new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Command\Command('foo'))->setCode(function () {
            });
        }]));
        $application->run(new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\ArrayInput(['command' => 'foo']), new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Output\NullOutput());
        $this->assertSame(['foo' => \true], $loaded);
    }
    protected function getDispatcher($skipCommand = \false)
    {
        $dispatcher = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\EventDispatcher\EventDispatcher();
        $dispatcher->addListener('console.command', function (\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Event\ConsoleCommandEvent $event) use($skipCommand) {
            $event->getOutput()->write('before.');
            if ($skipCommand) {
                $event->disableCommand();
            }
        });
        $dispatcher->addListener('console.terminate', function (\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Event\ConsoleTerminateEvent $event) use($skipCommand) {
            $event->getOutput()->writeln('after.');
            if (!$skipCommand) {
                $event->setExitCode(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Event\ConsoleCommandEvent::RETURN_CODE_DISABLED);
            }
        });
        $dispatcher->addListener('console.error', function (\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Event\ConsoleErrorEvent $event) {
    ...
    public function testCommandNameMismatchWithCommandLoaderKeyThrows()
    {
        ...
        $app = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application();
        $loader = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\CommandLoader\FactoryCommandLoader(['test' => static function () {
            return new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Command\Command('test-command');
        }]);
        $app->setCommandLoader($loader);
        $app->get('test');
    }
}
class CustomApplication extends \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application
{
    /**
     ...
     */
    protected function getDefaultInputDefinition() : \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputDefinition
    {
        return new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputDefinition([new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputOption('--custom', '-c', \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Set the custom input definition.')]);
    }
    /**
     ...
     */
    protected function getDefaultHelperSet() : \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Helper\HelperSet
    {
        return new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Helper\HelperSet([new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Helper\FormatterHelper()]);
    }
}
class CustomDefaultCommandApplication extends \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Application
{
    /**
...
class LazyCommand extends \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Command\Command
{
    public function execute(\TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Input\InputInterface $input, \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        $output->writeln('lazy-command called');
        return 0;
    }
}
class DisabledCommand extends \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Command\Command
{
