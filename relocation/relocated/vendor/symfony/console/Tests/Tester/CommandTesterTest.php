...
class CommandTesterTest extends \TenantCloud\BetterReflection\Relocated\PHPUnit\Framework\TestCase
{
    protected $command;
    protected $tester;
    protected function setUp() : void
    {
        $this->command = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Command\Command('foo');
        ...
        $this->tester->execute(['foo' => 'bar'], ['interactive' => \false, 'decorated' => \false, 'verbosity' => \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Output\Output::VERBOSITY_VERBOSE]);
    }
    ...
    public function testCommandFromApplication()
    {
        ...
        $tester = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Tester\CommandTester($application->find('foo'));
    ...
    public function testCommandWithInputs()
    {
        ...
        $command = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Command\Command('foo');
        $command->setHelperSet(new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Helper\HelperSet([new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Helper\QuestionHelper()]));
        $command->setCode(function ($input, $output) use($questions, $command) {
            $helper = $command->getHelper('question');
            $helper->ask($input, $output, new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Question\Question($questions[0]));
            $helper->ask($input, $output, new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Question\Question($questions[1]));
            $helper->ask($input, $output, new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Question\Question($questions[2]));
        });
    ...
    public function testCommandWithDefaultInputs()
    {
        ...
        $command->setCode(function ($input, $output) use($questions, $command) {
            $helper = $command->getHelper('question');
            $helper->ask($input, $output, new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Question\Question($questions[0], 'Bobby'));
            $helper->ask($input, $output, new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Question\Question($questions[1], 'Fine'));
            $helper->ask($input, $output, new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Question\Question($questions[2], 'France'));
        });
        $tester = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Tester\CommandTester($command);
        $tester->setInputs(['', '', '']);
        $tester->execute([]);
    ...
    public function testCommandWithWrongInputsNumber()
    {
        ...
        $command->setCode(function ($input, $output) use($questions, $command) {
            $helper = $command->getHelper('question');
            $helper->ask($input, $output, new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Question\ChoiceQuestion('choice', ['a', 'b']));
            $helper->ask($input, $output, new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Question\Question($questions[0]));
            $helper->ask($input, $output, new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Question\Question($questions[1]));
            $helper->ask($input, $output, new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Question\Question($questions[2]));
        });
    ...
    public function testErrorOutput()
    {
        ...
        $tester = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Tester\CommandTester($command);
        $tester->execute(['foo' => 'bar'], ['capture_stderr_separately' => \true]);
