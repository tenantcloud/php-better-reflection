...
namespace TenantCloud\BetterReflection\Relocated\Tests\Unit;

use TenantCloud\BetterReflection\Relocated\Jean85\Version;
use TenantCloud\BetterReflection\Relocated\PHPUnit\Framework\TestCase;
class VersionTest extends \TenantCloud\BetterReflection\Relocated\PHPUnit\Framework\TestCase
{
    ...
    {
        $version = new \TenantCloud\BetterReflection\Relocated\Jean85\Version('vendor/package', 'v1.0@51e867c70f0799790b3e82276875414ce13daaca');
    ...
    {
        $version = new \TenantCloud\BetterReflection\Relocated\Jean85\Version('vendor/package', $originalVersion);
        $this->assertSame($originalVersion, $version->getFullVersion());
    }
    public function fullVersionProvider() : array
    {
        return [[self::STABLE_VERSION], [self::STABLE_VERSION_WITH_V], [self::DEV_VERSION], [self::REPLACE_VERSION]];
    }
    /**
    ...
    {
        return [[self::STABLE_VERSION, '1.1.2'], [self::STABLE_VERSION_WITH_V, 'v1.7.0'], [self::DEV_VERSION, '9999999-dev@f6e77da'], [self::REPLACE_VERSION, 'self.version@aaabbbc']];
    }
    /**
    ...
    {
        return [[self::STABLE_VERSION, '1.1.2@51e867c'], [self::STABLE_VERSION_WITH_V, 'v1.7.0@93d39f1'], [self::DEV_VERSION, '9999999-dev@f6e77da'], [self::REPLACE_VERSION, 'self.version@aaabbbc']];
    }
    /**
    ...
    {
        return [[self::STABLE_VERSION, '1.1.2'], [self::STABLE_VERSION_WITH_V, 'v1.7.0'], [self::DEV_VERSION, '9999999-dev'], [self::REPLACE_VERSION, 'self.version']];
    }
    /**
    ...
    {
        return [[self::STABLE_VERSION, '51e867c70f0799790b3e82276875414ce13daaca'], [self::STABLE_VERSION_WITH_V, '93d39f1f7f9326d746203c7c056f300f7f126073'], [self::DEV_VERSION, 'f6e77da35a8420cc1923c3ad3f13b1a191ff0311'], [self::REPLACE_VERSION, 'aaabbbcccddd']];
    }
    /**
    ...
    {
        return [[self::STABLE_VERSION, '51e867c'], [self::STABLE_VERSION_WITH_V, '93d39f1'], [self::DEV_VERSION, 'f6e77da'], [self::REPLACE_VERSION, 'aaabbbc']];
    }
}
