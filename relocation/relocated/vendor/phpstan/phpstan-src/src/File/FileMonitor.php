...
class FileMonitor
{
    ...
    private $paths;
    public function __construct(\TenantCloud\BetterReflection\Relocated\PHPStan\File\FileFinder $fileFinder)
    {
    ...
    public function getChanges() : \TenantCloud\BetterReflection\Relocated\PHPStan\File\FileMonitorResult
    {
        ...
        return new \TenantCloud\BetterReflection\Relocated\PHPStan\File\FileMonitorResult($newFiles, $changedFiles, $deletedFiles, \count($fileHashes));
    }
    private function getFileHash(string $filePath) : string
    {
        return \sha1(\TenantCloud\BetterReflection\Relocated\PHPStan\File\FileReader::read($filePath));
    }
}
