...
class MemoizingContainer implements \TenantCloud\BetterReflection\Relocated\PHPStan\DependencyInjection\Container
{
    private \TenantCloud\BetterReflection\Relocated\PHPStan\DependencyInjection\Container $originalContainer;
    /** @var array<string, mixed> */
    private array $servicesByType = [];
    public function __construct(\TenantCloud\BetterReflection\Relocated\PHPStan\DependencyInjection\Container $originalContainer)
    {
