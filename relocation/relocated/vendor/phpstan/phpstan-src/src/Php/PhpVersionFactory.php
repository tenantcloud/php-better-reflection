...
class PhpVersionFactory
{
    ...
    public function create() : \TenantCloud\BetterReflection\Relocated\PHPStan\Php\PhpVersion
    {
        ...
        return new \TenantCloud\BetterReflection\Relocated\PHPStan\Php\PhpVersion($versionId);
    }
}
