...
class TypeTraverser
{
     ...
     */
    public static function map(\TenantCloud\BetterReflection\Relocated\PHPStan\Type\Type $type, callable $cb) : \TenantCloud\BetterReflection\Relocated\PHPStan\Type\Type
    {
        $self = new self($cb);
    ...
    /** @internal */
    public function mapInternal(\TenantCloud\BetterReflection\Relocated\PHPStan\Type\Type $type) : \TenantCloud\BetterReflection\Relocated\PHPStan\Type\Type
    {
        return ($this->cb)($type, [$this, 'traverseInternal']);
    }
    /** @internal */
    public function traverseInternal(\TenantCloud\BetterReflection\Relocated\PHPStan\Type\Type $type) : \TenantCloud\BetterReflection\Relocated\PHPStan\Type\Type
    {
