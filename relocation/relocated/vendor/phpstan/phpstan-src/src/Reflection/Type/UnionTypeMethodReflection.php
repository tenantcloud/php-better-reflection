...
class UnionTypeMethodReflection implements \TenantCloud\BetterReflection\Relocated\PHPStan\Reflection\MethodReflection
{
    ...
    public function getVariants() : array
    {
        ...
        $returnType = \TenantCloud\BetterReflection\Relocated\PHPStan\Type\TypeCombinator::union(...\array_map(static function (\TenantCloud\BetterReflection\Relocated\PHPStan\Reflection\MethodReflection $method) : Type {
            return \TenantCloud\BetterReflection\Relocated\PHPStan\Type\TypeCombinator::union(...\array_map(static function (\TenantCloud\BetterReflection\Relocated\PHPStan\Reflection\ParametersAcceptor $acceptor) : Type {
    ...
    {
        return \TenantCloud\BetterReflection\Relocated\PHPStan\TrinaryLogic::extremeIdentity(...\array_map(static function (\TenantCloud\BetterReflection\Relocated\PHPStan\Reflection\MethodReflection $method) : TrinaryLogic {
