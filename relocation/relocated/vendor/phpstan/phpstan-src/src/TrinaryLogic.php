...
class TrinaryLogic
{
    ...
    public function toBooleanType() : \TenantCloud\BetterReflection\Relocated\PHPStan\Type\BooleanType
    {
        if ($this->value === self::MAYBE) {
            return new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\BooleanType();
        }
        return new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\Constant\ConstantBooleanType($this->value === self::YES);
    }
