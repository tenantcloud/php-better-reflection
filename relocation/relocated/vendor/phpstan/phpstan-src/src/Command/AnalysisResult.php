...
class AnalysisResult
{
    ...
    {
        \usort($fileSpecificErrors, static function (\TenantCloud\BetterReflection\Relocated\PHPStan\Analyser\Error $a, \TenantCloud\BetterReflection\Relocated\PHPStan\Analyser\Error $b) : int {
