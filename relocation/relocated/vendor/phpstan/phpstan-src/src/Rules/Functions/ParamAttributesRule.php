 ...
 */
class ParamAttributesRule implements \TenantCloud\BetterReflection\Relocated\PHPStan\Rules\Rule
{
    ...
    {
        return \TenantCloud\BetterReflection\Relocated\PhpParser\Node\Param::class;
    }
