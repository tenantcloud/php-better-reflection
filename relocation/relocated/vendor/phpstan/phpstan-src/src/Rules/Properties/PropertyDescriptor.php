...
{
    public function describePropertyByName(\TenantCloud\BetterReflection\Relocated\PHPStan\Reflection\PropertyReflection $property, string $propertyName) : string
    {
     ...
     * @return string
     */
    public function describeProperty(\TenantCloud\BetterReflection\Relocated\PHPStan\Reflection\PropertyReflection $property, $propertyFetch) : string
    {
