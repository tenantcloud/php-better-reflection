 ...
 */
class ElseIfConstantConditionRule implements \TenantCloud\BetterReflection\Relocated\PHPStan\Rules\Rule
{
    ...
    {
        return \TenantCloud\BetterReflection\Relocated\PhpParser\Node\Stmt\ElseIf_::class;
    }
