 ...
 */
class ClassConstantAttributesRule implements \TenantCloud\BetterReflection\Relocated\PHPStan\Rules\Rule
{
    ...
    {
        return \TenantCloud\BetterReflection\Relocated\PhpParser\Node\Stmt\ClassConst::class;
    }
