...
class Analyser
{
    private \TenantCloud\BetterReflection\Relocated\PHPStan\Analyser\FileAnalyser $fileAnalyser;
    private \TenantCloud\BetterReflection\Relocated\PHPStan\Rules\Registry $registry;
    ...
    public function __construct(\TenantCloud\BetterReflection\Relocated\PHPStan\Analyser\FileAnalyser $fileAnalyser, \TenantCloud\BetterReflection\Relocated\PHPStan\Rules\Registry $registry, \TenantCloud\BetterReflection\Relocated\PHPStan\Analyser\NodeScopeResolver $nodeScopeResolver, int $internalErrorsCountLimit)
    {
     ...
     */
    public function analyse(array $files, ?\Closure $preFileCallback = null, ?\Closure $postFileCallback = null, bool $debug = \false, ?array $allAnalysedFiles = null) : \TenantCloud\BetterReflection\Relocated\PHPStan\Analyser\AnalyserResult
    {
        ...
        foreach ($files as $file) {
            ...
            try {
                ...
                $errors[] = new \TenantCloud\BetterReflection\Relocated\PHPStan\Analyser\Error($internalErrorMessage, $file, null, $t);
        ...
        return new \TenantCloud\BetterReflection\Relocated\PHPStan\Analyser\AnalyserResult($errors, [], $internalErrorsCount === 0 ? $dependencies : null, $exportedNodes, $reachedInternalErrorsCountLimit);
    }
    /**
    ...
    private function collectErrors(array $analysedFiles) : void
    {
        ...
        \set_error_handler(function (int $errno, string $errstr, string $errfile, int $errline) use($analysedFiles) : bool {
            ...
            $this->collectedErrors[] = new \TenantCloud\BetterReflection\Relocated\PHPStan\Analyser\Error($errstr, $errfile, $errline, \true);
            return \true;
        });
    }
