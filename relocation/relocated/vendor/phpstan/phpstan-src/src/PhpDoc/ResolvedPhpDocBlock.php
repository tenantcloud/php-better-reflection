...
use TenantCloud\BetterReflection\Relocated\PHPStan\PhpDoc\Tag\TypedTag;
...
{
    private \TenantCloud\BetterReflection\Relocated\PHPStan\PhpDocParser\Ast\PhpDoc\PhpDocNode $phpDocNode;
    /** @var PhpDocNode[] */
    private array $phpDocNodes;
    private string $phpDocString;
    private ?string $filename;
    private ?\TenantCloud\BetterReflection\Relocated\PHPStan\Analyser\NameScope $nameScope = null;
     ...
     * @return self
     */
    public static function create(\TenantCloud\BetterReflection\Relocated\PHPStan\PhpDocParser\Ast\PhpDoc\PhpDocNode $phpDocNode, string $phpDocString, string $filename, \TenantCloud\BetterReflection\Relocated\PHPStan\Analyser\NameScope $nameScope, \TenantCloud\BetterReflection\Relocated\PHPStan\Type\Generic\TemplateTypeMap $templateTypeMap, array $templateTags, \TenantCloud\BetterReflection\Relocated\PHPStan\PhpDoc\PhpDocNodeResolver $phpDocNodeResolver) : self
    {
    ...
    public static function createEmpty() : self
    {
        ...
        $self->phpDocNodes = [];
        $self->filename = null;
        $self->templateTypeMap = \TenantCloud\BetterReflection\Relocated\PHPStan\Type\Generic\TemplateTypeMap::createEmpty();
        $self->templateTags = [];
        $self->varTags = [];
        $self->methodTags = [];
        $self->propertyTags = [];
    ...
    private function getNameScope() : \TenantCloud\BetterReflection\Relocated\PHPStan\Analyser\NameScope
    {
        return $this->nameScope;
    }
    public function getNullableNameScope() : ?\TenantCloud\BetterReflection\Relocated\PHPStan\Analyser\NameScope
    {
        return $this->nameScope;
    }
    /**
    ...
    public function getReturnTag() : ?\TenantCloud\BetterReflection\Relocated\PHPStan\PhpDoc\Tag\ReturnTag
    {
    ...
    public function getThrowsTag() : ?\TenantCloud\BetterReflection\Relocated\PHPStan\PhpDoc\Tag\ThrowsTag
    {
    ...
    public function getDeprecatedTag() : ?\TenantCloud\BetterReflection\Relocated\PHPStan\PhpDoc\Tag\DeprecatedTag
    {
     ...
     */
    private static function mergeOneParentVarTags(self $parent, \TenantCloud\BetterReflection\Relocated\PHPStan\PhpDoc\PhpDocBlock $phpDocBlock) : ?array
    {
     ...
     * @return array<string, ParamTag>
     */
    private static function mergeOneParentParamTags(array $paramTags, self $parent, \TenantCloud\BetterReflection\Relocated\PHPStan\PhpDoc\PhpDocBlock $phpDocBlock) : array
    {
     ...
     */
    private static function mergeReturnTags(?\TenantCloud\BetterReflection\Relocated\PHPStan\PhpDoc\Tag\ReturnTag $returnTag, array $parents, array $parentPhpDocBlocks) : ?\TenantCloud\BetterReflection\Relocated\PHPStan\PhpDoc\Tag\ReturnTag
    {
        if ($returnTag !== null) {
            return $returnTag;
        }
    ...
    private static function mergeOneParentReturnTag(?\TenantCloud\BetterReflection\Relocated\PHPStan\PhpDoc\Tag\ReturnTag $returnTag, self $parent, \TenantCloud\BetterReflection\Relocated\PHPStan\PhpDoc\PhpDocBlock $phpDocBlock) : ?\TenantCloud\BetterReflection\Relocated\PHPStan\PhpDoc\Tag\ReturnTag
    {
     ...
     * @param array<int, self> $parents
     */
    private static function mergeThrowsTags(?\TenantCloud\BetterReflection\Relocated\PHPStan\PhpDoc\Tag\ThrowsTag $throwsTag, array $parents) : ?\TenantCloud\BetterReflection\Relocated\PHPStan\PhpDoc\Tag\ThrowsTag
    {
        if ($throwsTag !== null) {
            return $throwsTag;
        }
     ...
     * @return T
     */
    private static function resolveTemplateTypeInTag(\TenantCloud\BetterReflection\Relocated\PHPStan\PhpDoc\Tag\TypedTag $tag, \TenantCloud\BetterReflection\Relocated\PHPStan\PhpDoc\PhpDocBlock $phpDocBlock) : \TenantCloud\BetterReflection\Relocated\PHPStan\PhpDoc\Tag\TypedTag
    {
        $type = \TenantCloud\BetterReflection\Relocated\PHPStan\Type\Generic\TemplateTypeHelper::resolveTemplateTypes($tag->getType(), $phpDocBlock->getClassReflection()->getActiveTemplateTypeMap());
