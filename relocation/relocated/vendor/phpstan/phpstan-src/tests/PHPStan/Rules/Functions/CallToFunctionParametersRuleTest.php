 ...
 */
class CallToFunctionParametersRuleTest extends \TenantCloud\BetterReflection\Relocated\PHPStan\Testing\RuleTestCase
{
    protected function getRule() : \TenantCloud\BetterReflection\Relocated\PHPStan\Rules\Rule
    {
        $broker = $this->createReflectionProvider();
        return new \TenantCloud\BetterReflection\Relocated\PHPStan\Rules\Functions\CallToFunctionParametersRule($broker, new \TenantCloud\BetterReflection\Relocated\PHPStan\Rules\FunctionCallParametersCheck(new \TenantCloud\BetterReflection\Relocated\PHPStan\Rules\RuleLevelHelper($broker, \true, \false, \true, \false), new \TenantCloud\BetterReflection\Relocated\PHPStan\Rules\NullsafeCheck(), new \TenantCloud\BetterReflection\Relocated\PHPStan\Php\PhpVersion(80000), \true, \true, \true, \true));
    }
    ...
    public function testCallToFunctionWithOptionalParameters() : void
    {
        ...
        $this->analyse([__DIR__ . '/data/call-to-function-with-optional-parameters.php'], [['Function CallToFunctionWithOptionalParameters\\foo invoked with 3 parameters, 1-2 required.', 9], ['Parameter #1 $object of function get_class expects object, null given.', 12], ['Parameter #1 $object of function get_class expects object, object|null given.', 16]]);
    }
    ...
    public function testCallToFunctionWithNullableDynamicParameters() : void
    {
        ...
        $this->analyse([__DIR__ . '/data/function-with-nullable-variadic-parameters.php'], [['Function FunctionWithNullableVariadicParameters\\foo invoked with 0 parameters, at least 1 required.', 6]]);
    }
    public function testCallToFunctionWithDynamicIterableParameters() : void
    {
        require_once __DIR__ . '/data/function-with-variadic-parameters-definition.php';
        $this->analyse([__DIR__ . '/data/function-with-variadic-parameters-7.1.php'], [['Parameter #2 ...$foo of function FunctionWithVariadicParameters\\foo expects int, string given.', 16]]);
    }
    public function testCallToArrayUnique() : void
    {
        $this->analyse([__DIR__ . '/data/call-to-array-unique.php'], [['Function array_unique invoked with 3 parameters, 1-2 required.', 3]]);
    }
    ...
    public function testUnpackOnAfter711() : void
    {
        ...
        $this->analyse([__DIR__ . '/data/unpack.php'], [['Function unpack invoked with 0 parameters, 2-3 required.', 3]]);
    }
    public function testPassingNonVariableToParameterPassedByReference() : void
    {
        require_once __DIR__ . '/data/passed-by-reference.php';
        $this->analyse([__DIR__ . '/data/passed-by-reference.php'], [['Parameter #1 $foo of function PassedByReference\\foo is passed by reference, so it expects variables only.', 32], ['Parameter #1 $foo of function PassedByReference\\foo is passed by reference, so it expects variables only.', 33], ['Parameter #1 $array of function reset expects array, null given.', 39]]);
    }
    public function testImplodeOnPhp74() : void
    {
        ...
        $errors = [['Parameter #1 $glue of function implode expects string, array given.', 8], ['Parameter #2 $pieces of function implode expects array, string given.', 8]];
    ...
    public function testCallToFunctionInForeachCondition() : void
    {
        ...
        $this->analyse([__DIR__ . '/data/foreach-condition.php'], [['Parameter #1 $i of function CallToFunctionInForeachCondition\\takesString expects string, int given.', 20]]);
    }
    ...
    {
        $this->analyse([__DIR__ . '/data/unpack-operator.php'], [['Parameter #2 ...$values of function sprintf expects bool|float|int|string|null, array<string> given.', 18], ['Parameter #2 ...$values of function sprintf expects bool|float|int|string|null, array<int, string> given.', 19], ['Parameter #2 ...$values of function sprintf expects bool|float|int|string|null, UnpackOperator\\Foo given.', 22], ['Parameter #2 ...$values of function printf expects bool|float|int|string|null, UnpackOperator\\Foo given.', 24]]);
    }
    public function testFputCsv() : void
    {
        $this->analyse([__DIR__ . '/data/fputcsv-fields-parameter.php'], [['Parameter #2 $fields of function fputcsv expects array<int|string, bool|float|int|string|null>, array<int, Fputcsv\\Person> given.', 35]]);
    }
    ...
    {
        $this->analyse([__DIR__ . '/data/function-with-int-parameter-that-created-by-addition.php'], [['Parameter #1 $num of function dechex expects int, float|int given.', 40]]);
    }
    ...
    public function testGenericFunction() : void
    {
        ...
        $this->analyse([__DIR__ . '/data/call-generic-function.php'], [['TenantCloud\\BetterReflection\\Relocated\\Unable to resolve the template type A in call to function CallGenericFunction\\f', 15, 'See: https://phpstan.org/blog/solving-phpstan-error-unable-to-resolve-template-type'], ['Parameter #1 $a of function CallGenericFunction\\g expects DateTime, DateTimeImmutable given.', 26], ['TenantCloud\\BetterReflection\\Relocated\\Unable to resolve the template type A in call to function CallGenericFunction\\g', 26, 'See: https://phpstan.org/blog/solving-phpstan-error-unable-to-resolve-template-type']]);
    }
    public function testNamedArguments() : void
    {
        ...
        $errors = [['Missing parameter $j (int) in call to function FunctionNamedArguments\\foo.', 7], ['Unknown parameter $z in call to function FunctionNamedArguments\\foo.', 8], ['Unknown parameter $a in call to function array_merge.', 14]];
        if (\PHP_VERSION_ID < 80000) {
            $errors[] = ['Missing parameter $arr1 (array) in call to function array_merge.', 14];
        }
