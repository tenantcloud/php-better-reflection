...
class ParamAttributesRuleTest extends \TenantCloud\BetterReflection\Relocated\PHPStan\Testing\RuleTestCase
{
    ...
    public function testRule() : void
    {
        ...
        $this->analyse([__DIR__ . '/data/param-attributes.php'], [['Attribute class ParamAttributes\\Foo does not have the parameter target.', 27]]);
    }
}
