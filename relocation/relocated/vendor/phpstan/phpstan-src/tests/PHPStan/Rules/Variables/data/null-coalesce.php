...
namespace TenantCloud\BetterReflection\Relocated\CoalesceRule;
...
function coalesce()
{
    ...
    echo \rand() ?? 0;
    echo \preg_replace('', '', '') ?? 0;
    $foo = new \TenantCloud\BetterReflection\Relocated\CoalesceRule\FooCoalesce();
    echo $foo->stringOrNull ?? '';
    echo $foo->string ?? '';
    echo $foo->alwaysNull ?? '';
    echo $foo->fooCoalesce->string ?? '';
    echo $foo->fooCoalesceOrNull->string ?? '';
    echo \TenantCloud\BetterReflection\Relocated\CoalesceRule\FooCoalesce::$staticStringOrNull ?? '';
    echo \TenantCloud\BetterReflection\Relocated\CoalesceRule\FooCoalesce::$staticString ?? '';
    echo \TenantCloud\BetterReflection\Relocated\CoalesceRule\FooCoalesce::$staticAlwaysNull ?? '';
}
/**
...
function () : void {
    echo (new \TenantCloud\BetterReflection\Relocated\CoalesceRule\FooCoalesce())->string ?? 'foo';
    echo (new \TenantCloud\BetterReflection\Relocated\CoalesceRule\FooCoalesce())->stringOrNull ?? 'foo';
    echo (new \TenantCloud\BetterReflection\Relocated\CoalesceRule\FooCoalesce())->alwaysNull ?? 'foo';
    new \TenantCloud\BetterReflection\Relocated\CoalesceRule\FooCoalesce() ?? 'foo';
    null ?? 'foo';
};
function (\TenantCloud\BetterReflection\Relocated\CoalesceRule\FooCoalesce $foo) : void {
