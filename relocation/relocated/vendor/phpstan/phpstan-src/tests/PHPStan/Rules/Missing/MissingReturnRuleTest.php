...
class MissingReturnRuleTest extends \TenantCloud\BetterReflection\Relocated\PHPStan\Testing\RuleTestCase
{
    ...
    {
        $this->checkExplicitMixedMissingReturn = \true;
        $this->analyse([__DIR__ . '/data/missing-mixed-return-empty-body.php'], [['Method MissingMixedReturnEmptyBody\\HelloWorld::doFoo() should return mixed but return statement is missing.', 11]]);
    }
