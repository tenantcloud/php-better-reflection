...
namespace TenantCloud\BetterReflection\Relocated\IssetRule;
...
function coalesce()
{
    ...
    $foo = new \TenantCloud\BetterReflection\Relocated\IssetRule\FooCoalesce();
    ...
    echo isset(\TenantCloud\BetterReflection\Relocated\IssetRule\FooCoalesce::$staticStringOrNull) ? \TenantCloud\BetterReflection\Relocated\IssetRule\FooCoalesce::$staticStringOrNull : '';
    echo isset(\TenantCloud\BetterReflection\Relocated\IssetRule\FooCoalesce::$staticString) ? \TenantCloud\BetterReflection\Relocated\IssetRule\FooCoalesce::$staticString : '';
    echo isset(\TenantCloud\BetterReflection\Relocated\IssetRule\FooCoalesce::$staticAlwaysNull) ? \TenantCloud\BetterReflection\Relocated\IssetRule\FooCoalesce::$staticAlwaysNull : '';
}
/**
...
function () : void {
    echo isset((new \TenantCloud\BetterReflection\Relocated\IssetRule\FooCoalesce())->string) ? (new \TenantCloud\BetterReflection\Relocated\IssetRule\FooCoalesce())->string : 'foo';
    echo isset((new \TenantCloud\BetterReflection\Relocated\IssetRule\FooCoalesce())->stringOrNull) ? (new \TenantCloud\BetterReflection\Relocated\IssetRule\FooCoalesce())->stringOrNull : 'foo';
    echo isset((new \TenantCloud\BetterReflection\Relocated\IssetRule\FooCoalesce())->alwaysNull) ? (new \TenantCloud\BetterReflection\Relocated\IssetRule\FooCoalesce())->alwaysNull : 'foo';
};
function (\TenantCloud\BetterReflection\Relocated\IssetRule\FooCoalesce $foo) : void {
...
function (\TenantCloud\BetterReflection\Relocated\IssetRule\SomeMagicProperties $foo, \stdClass $std) : void {
