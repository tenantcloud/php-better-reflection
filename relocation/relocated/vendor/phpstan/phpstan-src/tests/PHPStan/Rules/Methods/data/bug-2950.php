...
namespace TenantCloud\BetterReflection\Relocated\Bug2950;
...
class AttributeMap implements \ArrayAccess
{
    /** @var Attribute[] */
    private $attributes = [];
    public function addAttribute(\TenantCloud\BetterReflection\Relocated\Bug2950\Attribute $attribute) : void
    {
        $this->attributes[$attribute->getId()] = $attribute;
    }
    public function getAttribute(int $id) : ?\TenantCloud\BetterReflection\Relocated\Bug2950\Attribute
    {
    ...
    {
        return \array_filter($this->attributes, function (\TenantCloud\BetterReflection\Relocated\Bug2950\Attribute $attribute) {
