...
namespace TenantCloud\BetterReflection\Relocated\ThrowValues;
...
function test($genericExceptionClassName, $genericException)
{
    ...
    if (\rand(0, 1)) {
        throw new \TenantCloud\BetterReflection\Relocated\ThrowValues\InvalidException();
    }
    if (\rand(0, 1)) {
    ...
    if (\rand(0, 1)) {
        throw new \TenantCloud\BetterReflection\Relocated\ThrowValues\NonexistentClass();
    }
    if (\rand(0, 1)) {
