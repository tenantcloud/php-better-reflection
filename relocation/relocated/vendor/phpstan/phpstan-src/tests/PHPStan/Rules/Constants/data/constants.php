...
namespace TenantCloud\BetterReflection\Relocated\Constants;

use const TenantCloud\BetterReflection\Relocated\OtherConstants\BAZ_CONSTANT;
echo FOO_CONSTANT;
echo BAR_CONSTANT;
echo \TenantCloud\BetterReflection\Relocated\OtherConstants\BAZ_CONSTANT;
