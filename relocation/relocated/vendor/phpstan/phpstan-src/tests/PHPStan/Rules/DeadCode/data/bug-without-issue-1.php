...
namespace TenantCloud\BetterReflection\Relocated\BugWithoutIssue1;
...
interface Message
{
    ...
    public function getFromUser() : \TenantCloud\BetterReflection\Relocated\BugWithoutIssue1\User;
}
...
class X
{
    public function checkAndSendThreadNotRepliedNotification(\TenantCloud\BetterReflection\Relocated\BugWithoutIssue1\MessageThread $thread) : bool
    {
...
class Foo
{
    ...
    protected $index = 0;
    /** @var string[][] */
    protected $data = [0 => ['type' => 'id', 'value' => 'foo'], 1 => ['type' => 'special', 'value' => '.'], 2 => ['type' => 'id', 'value' => 'bar'], 3 => ['type' => 'special', 'value' => ';']];
    ...
    public function separatedName() : string
    {
        ...
        while (($this->check('special', $separator) || $this->check('id')) && ($previousType === null || $this->type() !== $previousType) && ($previousType !== null || $currentValue !== $separator)) {
            $name .= $currentValue;
