...
class Bar extends \TenantCloud\BetterReflection\Relocated\Test\Foo
{
    ...
    public function dolor($foo, $bar, $baz)
    {
        ...
        $methodReflection = new \ReflectionMethod(\TenantCloud\BetterReflection\Relocated\Test\Bar::class, 'dolor');
        $methodReflection->invoke(new self());
        $methodReflection->invoke(new self(), 'foo', 'bar', 'baz');
    }
    protected function protectedMethodFromChild()
    {
        $foo = new \TenantCloud\BetterReflection\Relocated\Test\UnknownClass();
        $foo->doFoo();
        $this->returnsVoid();
...
function () {
    ...
    $reflectionClass = new \ReflectionClass(\TenantCloud\BetterReflection\Relocated\Test\Foo::class);
...
class ReturningSomethingFromConstructor
{
    ...
    {
        return new \TenantCloud\BetterReflection\Relocated\Test\Foo();
    }
}
function () {
    $obj = new \TenantCloud\BetterReflection\Relocated\Test\ReturningSomethingFromConstructor();
    $foo = $obj->__construct();
};
...
class UnionInsteadOfIntersection
{
    ...
    {
        while ($object instanceof \TenantCloud\BetterReflection\Relocated\Test\FirstInterface && $object instanceof \TenantCloud\BetterReflection\Relocated\Test\SecondInterface) {
            $object->firstMethod();
            $object->secondMethod();
...
{
    public function foo() : \TenantCloud\BetterReflection\Relocated\Test\Foo;
}
...
class MethodsOnUnionType
{
    ...
    public function doFoo()
    {
        ...
        // fine
        $this->object->bar();
        // WithFooMethod does not have bar()
    }
}
...
{
    public function doFoo(\TenantCloud\BetterReflection\Relocated\Test\WithFooMethod $foo)
    {
        if ($foo instanceof \TenantCloud\BetterReflection\Relocated\Test\SomeInterface) {
            $foo->foo();
            $foo->bar();
            $foo->foo()->test();
        }
...
class ObjectTypehint
{
    ...
    public function doBar(\TenantCloud\BetterReflection\Relocated\Test\Foo $foo)
    {
        $this->doFoo($foo);
        $this->doBar($foo);
    }
...
function () {
    ...
    foreach ([] as $val) {
        if ($foo === \false) {
            $foo = new \TenantCloud\BetterReflection\Relocated\Test\Foo();
        } else {
            $foo->ipsum();
            $foo->ipsum(1);
        }
...
class ScopeBelowInstanceofIsNoLongerChanged
{
    ...
    {
        $foo = doFoo();
        if ($foo instanceof \TenantCloud\BetterReflection\Relocated\Test\Foo) {
        }
...
class TernaryEvaluation
{
    ...
    public function doFoo($fooOrFalse)
    {
        ...
        $fooOrFalse ? $this->doBar($fooOrFalse) : $this->doBar($fooOrFalse);
    }
...
class LiteralArrayTypeCheck
{
    ...
    {
        $data = ['string' => 'foo', 'int' => 12, 'bool' => \true];
...
class WeirdStaticIssueImpl extends \TenantCloud\BetterReflection\Relocated\Test\WeirdStaticIssueBase
{
}
function () {
    /** @var WeirdStaticIssueImpl|int */
    $a = new \TenantCloud\BetterReflection\Relocated\Test\WeirdStaticIssueImpl();
    \TenantCloud\BetterReflection\Relocated\Test\WeirdStaticIssueImpl::get($a);
};
...
{
    public function doFoo(?string $q, ?\TenantCloud\BetterReflection\Relocated\Test\Foo $foo)
    {
        if (empty($q)) {
            return;
        }
...
class MethodExists
{
    public function doFoo(\TenantCloud\BetterReflection\Relocated\Test\Foo $foo, $mixed)
    {
        $foo->lorem();
...
class AssertInIf
{
    ...
    {
        if ($x) {
            $o = new \TenantCloud\BetterReflection\Relocated\Test\Foo();
            \assert($o instanceof \TenantCloud\BetterReflection\Relocated\Test\Bar);
        } else {
            $o = new \TenantCloud\BetterReflection\Relocated\Test\Bar();
        }
        $this->requireChild($o);
    }
    public function requireChild(\TenantCloud\BetterReflection\Relocated\Test\Bar $child)
    {
    }
    public function doBar()
    {
        $array = [new \TenantCloud\BetterReflection\Relocated\Test\Foo(), new \TenantCloud\BetterReflection\Relocated\Test\Bar()];
        $arrayToPass = [];
        foreach ($array as $item) {
            if (!$item instanceof \TenantCloud\BetterReflection\Relocated\Test\Bar) {
                continue;
            }
            $arrayToPass[] = $item;
        }
...
class AssignmentInInstanceOf
{
    public function doFoo()
    {
        $x = ($foo = $this->doBar()) instanceof self ? $foo->doFoo() : [];
    }
    /**
     * @return self|bool
     */
...
class ExpectsExceptionGenerics
{
    ...
    public function requiresFoo(\TenantCloud\BetterReflection\Relocated\Test\Foo $foo)
    {
    }
}
class WithStringOrNull
{
    public function bar(\TenantCloud\BetterReflection\Relocated\Test\ClassWithToString $bar = null) : void
    {
        $this->baz($bar);
    }
...
class IterableUnpackCallMethods
{
     ...
     */
    public function doFoo(array $integers, ?array $integersOrNull, string $str, $mixed)
    {
        $this->doBar(...[1, 2, 3], ...$integers, ...$integersOrNull, ...2, ...$str, ...$mixed);
    }
...
class AppleCollection extends \TenantCloud\BetterReflection\Relocated\Test\CollectionWithStaticParam
{
    public function doFoo()
    {
        $this->add(new \TenantCloud\BetterReflection\Relocated\Test\AppleCollection());
    }
}
function () {
    $foo = new \TenantCloud\BetterReflection\Relocated\Test\AppleCollection();
    $foo->add(new \TenantCloud\BetterReflection\Relocated\Test\AppleCollection());
};
...
{
    public function doFoo(\TenantCloud\BetterReflection\Relocated\Test\Foo $foo)
    {
        /** @var Bar $foo */
        $foo->lorem();
    }
