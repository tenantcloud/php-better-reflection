...
namespace TenantCloud\BetterReflection\Relocated\TestAccessProperties;
...
class BarAccessProperties extends \TenantCloud\BetterReflection\Relocated\TestAccessProperties\FooAccessProperties
{
    private $foobar;
    public function foo()
    {
        ...
        $this->ipsum;
        $this->foobar;
        \TenantCloud\BetterReflection\Relocated\TestAccessProperties\Foo::class;
        $string = 'foo';
...
class BazAccessProperties
{
    ...
    {
        $foo = new \TenantCloud\BetterReflection\Relocated\TestAccessProperties\FooAccessProperties();
        $foo->foo;
        $foo->bar;
        $foo->ipsum;
        if (isset($foo->baz)) {
        ...
        $foo->nonexistent;
        $fooAlias = new \TenantCloud\BetterReflection\Relocated\TestAccessProperties\FooAccessPropertiesAlias();
        $fooAlias->foo;
        $fooAlias->bar;
        $fooAlias->ipsum;
        $bar = new \TenantCloud\BetterReflection\Relocated\TestAccessProperties\UnknownClass();
        $bar->foo;
...
class NullPropertyIssue
{
    ...
    public function doFoo()
    {
        ...
        if (doSomething()) {
            $this->fooOrNull = new \TenantCloud\BetterReflection\Relocated\TestAccessProperties\FooAccessProperties();
        } else {
            $this->fooOrNull = new \TenantCloud\BetterReflection\Relocated\TestAccessProperties\FooAccessProperties();
        }
...
class PropertiesOnUnionType
{
    ...
    public function doFoo()
    {
        ...
        // fine
        $this->object->bar;
        // WithFooProperty does not have $bar
    }
}
...
{
    public function doFoo(\TenantCloud\BetterReflection\Relocated\TestAccessProperties\WithFooProperty $foo)
    {
        if ($foo instanceof \TenantCloud\BetterReflection\Relocated\TestAccessProperties\SomeInterface) {
            $foo->foo;
            $foo->bar;
        }
    }
