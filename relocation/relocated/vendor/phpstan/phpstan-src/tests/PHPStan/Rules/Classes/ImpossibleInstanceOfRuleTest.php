 ...
 */
class ImpossibleInstanceOfRuleTest extends \TenantCloud\BetterReflection\Relocated\PHPStan\Testing\RuleTestCase
{
    /** @var bool */
    ...
    {
        return new \TenantCloud\BetterReflection\Relocated\PHPStan\Rules\Classes\ImpossibleInstanceOfRule($this->checkAlwaysTrueInstanceOf, $this->treatPhpDocTypesAsCertain);
    }
    ...
    public function testInstanceofWithoutAlwaysTrue() : void
    {
        ...
        $this->treatPhpDocTypesAsCertain = \true;
        $tipText = 'Because the type is coming from a PHPDoc, you can turn off this check by setting <fg=cyan>treatPhpDocTypesAsCertain: false</> in your <fg=cyan>%configurationFile%</>.';
        $this->analyse([__DIR__ . '/data/impossible-instanceof.php'], [['Instanceof between ImpossibleInstanceOf\\Dolor and ImpossibleInstanceOf\\Lorem will always evaluate to false.', 71], ['Instanceof between string and ImpossibleInstanceOf\\Foo will always evaluate to false.', 94], ['Instanceof between string and string will always evaluate to false.', 98], ['Instanceof between ImpossibleInstanceOf\\Test|null and ImpossibleInstanceOf\\Lorem will always evaluate to false.', 119], ['Instanceof between ImpossibleInstanceOf\\Test|null and ImpossibleInstanceOf\\Lorem will always evaluate to false.', 137], ['Instanceof between ImpossibleInstanceOf\\Test|null and ImpossibleInstanceOf\\Lorem will always evaluate to false.', 155], ['Instanceof between callable and ImpossibleInstanceOf\\FinalClassWithoutInvoke will always evaluate to false.', 204], ['Instanceof between *NEVER* and ImpossibleInstanceOf\\Lorem will always evaluate to false.', 228], ['Instanceof between *NEVER* and ImpossibleInstanceOf\\Foo will always evaluate to false.', 234, $tipText], ['Instanceof between *NEVER* and ImpossibleInstanceOf\\Bar will always evaluate to false.', 240], ['Instanceof between object and Exception will always evaluate to false.', 303], ['Instanceof between object and InvalidArgumentException will always evaluate to false.', 307], ['Instanceof between ImpossibleInstanceOf\\Bar and ImpossibleInstanceOf\\BarChild will always evaluate to false.', 318], ['Instanceof between ImpossibleInstanceOf\\Bar and ImpossibleInstanceOf\\BarGrandChild will always evaluate to false.', 322], ['Instanceof between mixed and int results in an error.', 353], ['Instanceof between mixed and ImpossibleInstanceOf\\InvalidTypeTest|int results in an error.', 362], ['Instanceof between class-string<DateTimeInterface> and DateTimeInterface will always evaluate to false.', 418, $tipText], ['Instanceof between class-string<DateTimeInterface> and class-string<DateTimeInterface> will always evaluate to false.', 419], ['Instanceof between class-string<DateTimeInterface> and string will always evaluate to false.', 432, $tipText]]);
    }
    public function testDoNotReportTypesFromPhpDocs() : void
    {
        $this->checkAlwaysTrueInstanceOf = \true;
        $this->treatPhpDocTypesAsCertain = \false;
        $this->analyse([__DIR__ . '/data/impossible-instanceof-not-phpdoc.php'], [['Instanceof between stdClass and stdClass will always evaluate to true.', 12], ['Instanceof between stdClass and Exception will always evaluate to false.', 15], ['Instanceof between DateTimeImmutable and DateTimeInterface will always evaluate to true.', 27], ['Instanceof between DateTimeImmutable and ImpossibleInstanceofNotPhpDoc\\SomeFinalClass will always evaluate to false.', 30]]);
    }
    public function testReportTypesFromPhpDocs() : void
    {
        $this->checkAlwaysTrueInstanceOf = \true;
        $this->treatPhpDocTypesAsCertain = \true;
        $this->analyse([__DIR__ . '/data/impossible-instanceof-not-phpdoc.php'], [['Instanceof between stdClass and stdClass will always evaluate to true.', 12], ['Instanceof between stdClass and Exception will always evaluate to false.', 15], ['Instanceof between DateTimeImmutable and DateTimeInterface will always evaluate to true.', 27], ['Instanceof between DateTimeImmutable and ImpossibleInstanceofNotPhpDoc\\SomeFinalClass will always evaluate to false.', 30], ['Instanceof between DateTimeImmutable and DateTimeImmutable will always evaluate to true.', 33, 'Because the type is coming from a PHPDoc, you can turn off this check by setting <fg=cyan>treatPhpDocTypesAsCertain: false</> in your <fg=cyan>%configurationFile%</>.'], ['Instanceof between DateTimeImmutable and DateTime will always evaluate to false.', 36]]);
    }
