...
function (int $int1, int $int2, string $str1, string $str2) {
    $int1 << $int2;
    $int1 >> $int2;
    $int1 >>= $int2;
    $str1 << $str2;
...
function (string $string1, string $string2, \stdClass $std, \TenantCloud\BetterReflection\Relocated\Test\ClassWithToString $classWithToString) {
    $string1 . $string2;
    $string1 . $std;
...
function () {
    ...
    $o->user ?? '';
    $o->user->name ?? '';
    \TenantCloud\BetterReflection\Relocated\nonexistentFunction() ?? '';
};
function () {
    $possibleZero = 0;
