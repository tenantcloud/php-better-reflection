...
// lint >= 7.4
namespace TenantCloud\BetterReflection\Relocated\CoalesceAssignRule;
...
function coalesce()
{
    ...
    $foo = new \TenantCloud\BetterReflection\Relocated\CoalesceAssignRule\FooCoalesce();
    echo $foo->stringOrNull ??= '';
    echo $foo->string ??= '';
    echo $foo->alwaysNull ??= '';
    echo $foo->fooCoalesce->string ??= '';
    echo $foo->fooCoalesceOrNull->string ??= '';
    echo \TenantCloud\BetterReflection\Relocated\CoalesceAssignRule\FooCoalesce::$staticStringOrNull ??= '';
    echo \TenantCloud\BetterReflection\Relocated\CoalesceAssignRule\FooCoalesce::$staticString ??= '';
    echo \TenantCloud\BetterReflection\Relocated\CoalesceAssignRule\FooCoalesce::$staticAlwaysNull ??= '';
}
/**
