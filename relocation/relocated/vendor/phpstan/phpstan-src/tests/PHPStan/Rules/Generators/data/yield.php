...
namespace TenantCloud\BetterReflection\Relocated\YieldTypeRuleTest;
...
class Foo
{
    ...
    {
        (yield [new \DateTime(), new \DateTime(), new \stdClass(), new \DateTimeImmutable('2019-10-26')]);
    }
}
/**
 * @template TKey
...
class TestMap
{
    ...
    function iterator_map(iterable $iterator, callable $callback) : iterable
    {
        foreach ($iterator as $key => $value) {
            ...
            if ($result instanceof \TenantCloud\BetterReflection\Relocated\YieldTypeRuleTest\Map) {
