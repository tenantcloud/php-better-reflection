...
namespace TenantCloud\BetterReflection\Relocated\CallCallables;
...
class Foo
{
    ...
    {
        ['TenantCloud\\BetterReflection\\Relocated\\CallCallables\\Foo', 'doStaticBaz']();
        ['TenantCloud\\BetterReflection\\Relocated\\CallCallables\\Foo', 'doStaticBaz']('foo');
...
function (\Closure $closure) {
    [new \TenantCloud\BetterReflection\Relocated\CallCallables\Foo(), 'privateFooMethod']();
    $closure(1, 2, 3);
...
function (\TenantCloud\BetterReflection\Relocated\CallCallables\Bar $bar) {
    $bar();
};
class Baz
{
    ...
    {
        $f = function (\TenantCloud\BetterReflection\Relocated\CallCallables\Foo ...$foo) {
        };
        $f($foos);
        $f(...$foos);
    }
    ...
    {
        $baz = new \TenantCloud\BetterReflection\Relocated\CallCallables\Baz();
        $baz();
