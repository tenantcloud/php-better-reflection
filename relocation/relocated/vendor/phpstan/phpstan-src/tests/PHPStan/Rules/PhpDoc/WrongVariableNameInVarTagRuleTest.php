...
class WrongVariableNameInVarTagRuleTest extends \TenantCloud\BetterReflection\Relocated\PHPStan\Testing\RuleTestCase
{
    ...
    {
        $this->analyse([__DIR__ . '/data/bug-4500.php'], [['PHPDoc tag @var above multiple global variables does not specify variable name.', 23], ['Variable $baz in PHPDoc tag @var does not match any global variable: $lorem', 43], ['Variable $baz in PHPDoc tag @var does not match any global variable: $lorem', 49]]);
    }
