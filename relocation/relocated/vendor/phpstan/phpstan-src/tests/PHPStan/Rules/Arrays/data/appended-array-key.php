...
namespace TenantCloud\BetterReflection\Relocated\AppendedArrayKey;
...
class Foo
{
     ...
     */
    public function doFoo(int $int, string $string, $intOrString, ?string $stringOrNull)
    {
        ...
        $this->stringArray[$stringOrNull] = 1;
...
class Bar
{
    ...
    {
        $this->classStringKey[$s] = \true;
    }
    public function doBar()
    {
        $this->classStringKey[\stdClass::class] = \true;
    }
}
