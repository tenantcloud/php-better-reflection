...
class ExistingClassesInTypehintsRuleTest extends \TenantCloud\BetterReflection\Relocated\PHPStan\Testing\RuleTestCase
{
    ...
    public function testVoidParameterTypehint() : void
    {
        ...
        $this->analyse([__DIR__ . '/data/void-parameter-typehint.php'], [['Parameter $param of function VoidParameterTypehint\\doFoo() has invalid typehint type void.', 9]]);
    }
    public function dataNativeUnionTypes() : array
    {
        return [[70400, [['Function NativeUnionTypesSupport\\foo() uses native union types but they\'re supported only on PHP 8.0 and later.', 5], ['Function NativeUnionTypesSupport\\bar() uses native union types but they\'re supported only on PHP 8.0 and later.', 10]]], [80000, []]];
    }
    /**
    ...
    {
        return [[70400, []], [80000, [['Deprecated in PHP 8.0: Required parameter $bar follows optional parameter $foo.', 5], ['Deprecated in PHP 8.0: Required parameter $bar follows optional parameter $foo.', 14], ['Deprecated in PHP 8.0: Required parameter $bar follows optional parameter $foo.', 18]]]];
    }
    /**
