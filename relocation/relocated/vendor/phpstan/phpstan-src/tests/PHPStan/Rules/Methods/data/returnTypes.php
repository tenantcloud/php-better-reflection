...
class Foo extends \TenantCloud\BetterReflection\Relocated\ReturnTypes\FooParent implements \TenantCloud\BetterReflection\Relocated\ReturnTypes\FooInterface
{
    ...
    public function returnObject() : \TenantCloud\BetterReflection\Relocated\ReturnTypes\Bar
    {
        if (\rand(0, 1)) {
            return 1;
        }
    ...
    public function returnInterface() : \TenantCloud\BetterReflection\Relocated\ReturnTypes\FooInterface
    {
        return new self();
    }
    /**
     ...
     * @return static
     */
    public function returnStatic() : \TenantCloud\BetterReflection\Relocated\ReturnTypes\FooParent
    {
        if (\rand(0, 1)) {
            return parent::returnStatic();
        }
        $parent = new \TenantCloud\BetterReflection\Relocated\ReturnTypes\FooParent();
        if (\rand(0, 1)) {
            return $parent->returnStatic();
    ...
    public function returnAlias() : \TenantCloud\BetterReflection\Relocated\ReturnTypes\Foo
    {
        return new \TenantCloud\BetterReflection\Relocated\ReturnTypes\FooAlias();
    }
    public function returnAnotherAlias() : \TenantCloud\BetterReflection\Relocated\ReturnTypes\FooAlias
    {
    ...
    public function returnUnionIterableType($collection)
    {
        ...
        if (\rand(0, 1)) {
            return new \TenantCloud\BetterReflection\Relocated\ReturnTypes\Collection();
        }
        if (\rand(0, 1)) {
            return new self();
        }
    ...
    public function returnsParent() : \TenantCloud\BetterReflection\Relocated\parent
    {
        if (\rand(0, 1)) {
            return new \TenantCloud\BetterReflection\Relocated\ReturnTypes\FooParent();
        }
        if (\rand(0, 1)) {
            return 1;
        }
    ...
    public function misleadingBoolReturnType() : \TenantCloud\BetterReflection\Relocated\ReturnTypes\boolean
    {
        if (\rand(0, 1)) {
            return \true;
        }
        ...
        if (\rand(0, 1)) {
            return new \TenantCloud\BetterReflection\Relocated\ReturnTypes\boolean();
        }
    }
    public function misleadingIntReturnType() : \TenantCloud\BetterReflection\Relocated\ReturnTypes\integer
    {
        if (\rand(0, 1)) {
            return 1;
        }
        ...
        if (\rand(0, 1)) {
            return new \TenantCloud\BetterReflection\Relocated\ReturnTypes\integer();
        }
    }
    public function misleadingMixedReturnType() : mixed
    {
        ...
        if (\rand(0, 1)) {
            return new \TenantCloud\BetterReflection\Relocated\ReturnTypes\mixed();
        }
    }
}
class FooChild extends \TenantCloud\BetterReflection\Relocated\ReturnTypes\Foo
{
}
class Stock
{
...
class ReturnTernary
{
     ...
     * @return Foo
     */
    public function returnTernary($fooOrFalse) : \TenantCloud\BetterReflection\Relocated\ReturnTypes\Foo
    {
        if (\rand(0, 1)) {
            return $fooOrFalse ?: new \TenantCloud\BetterReflection\Relocated\ReturnTypes\Foo();
        }
        if (\rand(0, 1)) {
            return $fooOrFalse !== \false ? $fooOrFalse : new \TenantCloud\BetterReflection\Relocated\ReturnTypes\Foo();
        }
        if (\rand(0, 1)) {
            $fooOrFalse ? $fooResult = $fooOrFalse : new \TenantCloud\BetterReflection\Relocated\ReturnTypes\Foo();
            return $fooResult;
        }
        if (\rand(0, 1)) {
...
class ArrayFillKeysIssue
{
    ...
    public function getIPs(array $stringIds)
    {
        ...
        foreach ($stringIds as $id) {
            $paired[$id][] = new \TenantCloud\BetterReflection\Relocated\ReturnTypes\Foo();
        }
        return $paired;
    }
    /**
    ...
    public function getIPs2(array $stringIds)
    {
        $paired = \array_fill_keys($stringIds, []);
        foreach ($stringIds as $id) {
            $paired[$id][] = new \TenantCloud\BetterReflection\Relocated\ReturnTypes\Bar();
        }
        return $paired;
    }
}
class AssertThisInstanceOf
{
    ...
    {
        \assert($this instanceof \TenantCloud\BetterReflection\Relocated\ReturnTypes\FooInterface);
        return $this;
    }
    /**
     * @return $this
    ...
    public function doBar()
    {
        ...
        \assert($otherInstance instanceof \TenantCloud\BetterReflection\Relocated\ReturnTypes\FooInterface);
...
class Foo2 extends \TenantCloud\BetterReflection\Relocated\ReturnTypes\FooParent implements \TenantCloud\BetterReflection\Relocated\ReturnTypes\FooInterface
{
...
class ClassThatImplementsInterfaceAndInheritDocsIt implements \TenantCloud\BetterReflection\Relocated\ReturnTypes\InterfaceThatWillBeDocInherited
{
    public function setTableSchema() : \TenantCloud\BetterReflection\Relocated\ReturnTypes\InterfaceThatWillBeDocInherited
    {
        return $this;
    }
    /**
     * {@inheritDoc}
     */
    public function setTableSchema2() : \TenantCloud\BetterReflection\Relocated\ReturnTypes\InterfaceThatWillBeDocInherited
    {
        return $this;
    }
    /**
     * @inheritDoc
     */
    public function setTableSchema3() : \TenantCloud\BetterReflection\Relocated\ReturnTypes\InterfaceThatWillBeDocInherited
    {
        return $this;
    }
    /**
     * @inheritDoc
     */
    public function setTableSchema4() : \TenantCloud\BetterReflection\Relocated\ReturnTypes\InterfaceThatWillBeDocInherited
    {
        return $this;
    }
    /**
     * @inheritDoc
     */
    public function setTableSchema5() : \TenantCloud\BetterReflection\Relocated\ReturnTypes\InterfaceThatWillBeDocInherited
    {
        return $this;
    }
}
