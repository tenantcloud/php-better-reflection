 ...
 */
class ExistingClassesInClosureTypehintsRuleTest extends \TenantCloud\BetterReflection\Relocated\PHPStan\Testing\RuleTestCase
{
    /** @var int */
    ...
    public function testVoidParameterTypehint() : void
    {
        ...
        $this->analyse([__DIR__ . '/data/void-parameter-typehint.php'], [['Parameter $param of anonymous function has invalid typehint type void.', 5]]);
    }
    public function dataNativeUnionTypes() : array
    {
        return [[70400, [['Anonymous function uses native union types but they\'re supported only on PHP 8.0 and later.', 15], ['Anonymous function uses native union types but they\'re supported only on PHP 8.0 and later.', 19]]], [80000, []]];
    }
    /**
    ...
    {
        return [[70400, []], [80000, [['Deprecated in PHP 8.0: Required parameter $bar follows optional parameter $foo.', 5], ['Deprecated in PHP 8.0: Required parameter $bar follows optional parameter $foo.', 13], ['Deprecated in PHP 8.0: Required parameter $bar follows optional parameter $foo.', 17]]]];
    }
    /**
