...
namespace TenantCloud\BetterReflection\Relocated\NonexistentOffset;

class Foo
{
    public function nonexistentOffsetOnArray()
    {
        $array = ['a' => new \stdClass(), 2];
        echo $array['a'];
        echo $array[0];
        echo $array['b'];
        echo $array[1];
    ...
    {
        $array = ['foo' => NONEXISTENT_CONSTANT];
        echo $array['foo'];
    }
    ...
    public function classDoesNotExist(\TenantCloud\BetterReflection\Relocated\NonexistentOffset\Bar $foo)
    {
        echo $foo['bar'];
        $foo[] = 'test';
    }
     ...
     */
    public function offsetAccessibleOnPrimitiveTypes(int $int, float $float, bool $bool, $resource)
    {
        $int[42];
        $float[42];
        $bool[42];
    ...
    public function offsetExistsOnArrayAccess(\ArrayAccess $access)
    {
        echo $access['name'];
    }
    public function issetProblem(string $s)
    {
        $a = ['b' => ['c' => \false], 'c' => ['c' => \true], 'd' => ['e' => \true]];
        if (isset($a[$s]['c'])) {
            echo $a[$s];
            echo $a[$s]['c'];
        }
     ...
     */
    public function generalArrayHasOffsetOfDifferentType(array $array, string $s)
    {
        echo $array[$s];
        if (isset($array[$s])) {
            echo $array[$s];
     ...
     */
    public function arraysWithNull(array $intArray, array $stringArray, array $intOrStringArray, int $int, string $string, $intOrNull)
    {
        echo $intArray[$int];
    ...
    public function simpleXMLElementSubclassArrayAccess(\TenantCloud\BetterReflection\Relocated\NonexistentOffset\SubClassSimpleXMLElement $xml)
    {
        echo $xml['asdf'];
    }
