...
class RunnableQueueTest extends \TenantCloud\BetterReflection\Relocated\PHPUnit\Framework\TestCase
{
    public function testQueuedProcessIsRun() : void
    {
        $logger = new \TenantCloud\BetterReflection\Relocated\PHPStan\Process\Runnable\RunnableQueueLoggerStub();
        $queue = new \TenantCloud\BetterReflection\Relocated\PHPStan\Process\Runnable\RunnableQueue($logger, 8);
        $one = new \TenantCloud\BetterReflection\Relocated\PHPStan\Process\Runnable\RunnableStub('1');
        $queue->queue($one, 1);
        ...
        $this->assertSame(['Queue not full - looking at first item in the queue', 'Removing top item from queue - new size is 1', 'Running process 1', 'Process 1 finished successfully', 'Queue empty'], $logger->getMessages());
    }
    public function testComplexScenario() : void
    {
        ...
        $queue = new \TenantCloud\BetterReflection\Relocated\PHPStan\Process\Runnable\RunnableQueue($logger, 8);
        $one = new \TenantCloud\BetterReflection\Relocated\PHPStan\Process\Runnable\RunnableStub('1');
        $two = new \TenantCloud\BetterReflection\Relocated\PHPStan\Process\Runnable\RunnableStub('2');
        $three = new \TenantCloud\BetterReflection\Relocated\PHPStan\Process\Runnable\RunnableStub('3');
        $four = new \TenantCloud\BetterReflection\Relocated\PHPStan\Process\Runnable\RunnableStub('4');
        $queue->queue($one, 4);
        $this->assertSame(0, $queue->getQueueSize());
    ...
    public function testCancel() : void
    {
        ...
        $this->assertSame(0, $queue->getQueueSize());
        $this->assertSame(0, $queue->getRunningSize());
        $this->assertSame([0 => 'Queue not full - looking at first item in the queue', 1 => 'Removing top item from queue - new size is 4', 2 => 'Running process 1', 3 => 'Process 1 finished unsuccessfully: Runnable 1 canceled', 4 => 'Else callback in test called: Runnable 1 canceled', 5 => 'Queue empty'], $logger->getMessages());
    }
    public function testCancelAll() : void
    {
        $logger = new \TenantCloud\BetterReflection\Relocated\PHPStan\Process\Runnable\RunnableQueueLoggerStub();
        $queue = new \TenantCloud\BetterReflection\Relocated\PHPStan\Process\Runnable\RunnableQueue($logger, 6);
        $one = new \TenantCloud\BetterReflection\Relocated\PHPStan\Process\Runnable\RunnableStub('1');
        $two = new \TenantCloud\BetterReflection\Relocated\PHPStan\Process\Runnable\RunnableStub('2');
        $three = new \TenantCloud\BetterReflection\Relocated\PHPStan\Process\Runnable\RunnableStub('3');
        $queue->queue($one, 3);
