...
namespace TenantCloud\BetterReflection\Relocated\Levels\AcceptTypes;
...
class Foo
{
     ...
     * @param int|float $m
     */
    public function doFoo(int $i, float $j, $k, ?int $l, $m)
    {
        $this->doBar($i);
        $this->doBar($j);
        $this->doBar($k);
     ...
     * @param int|null $d
     */
    public function doBaz($a, $b, int $c, ?int $d)
    {
        $this->doLorem($a);
        $this->doLorem($b);
        $this->doLorem($c);
     ...
     * @param (int|float)[] $m
     */
    public function doFooArray(array $i, array $j, array $k, array $l, array $m)
    {
        $this->doBarArray($i);
        $this->doBarArray($j);
        $this->doBarArray($k);
     ...
     */
    public function callableArray(array $array)
    {
     ...
     * @param string $string
     */
    public function iterableCountable(iterable $iterable, array $array, $generic, string $string)
    {
        echo \count($iterable);
        echo \count($array);
        echo \count($generic);
...
interface FooInterface extends \TenantCloud\BetterReflection\Relocated\Levels\AcceptTypes\ParentFooInterface
{
}
interface FooCountableInterface extends \Countable
{
}
class FooImpl implements \TenantCloud\BetterReflection\Relocated\Levels\AcceptTypes\FooInterface
{
}
class ClosureAccepts
{
    public function doFoo(\TenantCloud\BetterReflection\Relocated\Levels\AcceptTypes\ParentFooInterface $parent)
    {
        $c = function (\TenantCloud\BetterReflection\Relocated\Levels\AcceptTypes\FooInterface $x, $y) : FooInterface {
            return new \TenantCloud\BetterReflection\Relocated\Levels\AcceptTypes\FooImpl();
        };
        $this->doBar($c);
        $this->doBaz($c);
        $c = function (\TenantCloud\BetterReflection\Relocated\Levels\AcceptTypes\FooInterface $x) : FooInterface {
            // less parameters - OK
            return new \TenantCloud\BetterReflection\Relocated\Levels\AcceptTypes\FooImpl();
        };
        $this->doBar($c);
        $this->doBaz($c);
        $c = function (\TenantCloud\BetterReflection\Relocated\Levels\AcceptTypes\FooInterface $x, $y, $z) : FooInterface {
            // more parameters - error
            return new \TenantCloud\BetterReflection\Relocated\Levels\AcceptTypes\FooImpl();
        };
        $this->doBar($c);
        $this->doBaz($c);
        $c = function (\TenantCloud\BetterReflection\Relocated\Levels\AcceptTypes\ParentFooInterface $x) : FooInterface {
            // parameter contravariance - OK
            return new \TenantCloud\BetterReflection\Relocated\Levels\AcceptTypes\FooImpl();
        };
        $this->doBar($c);
        $this->doBaz($c);
        $c = function (\TenantCloud\BetterReflection\Relocated\Levels\AcceptTypes\FooImpl $x) : FooInterface {
            // parameter covariance - error
            return new \TenantCloud\BetterReflection\Relocated\Levels\AcceptTypes\FooImpl();
        };
        $this->doBar($c);
        $this->doBaz($c);
        $c = function (\TenantCloud\BetterReflection\Relocated\Levels\AcceptTypes\FooInterface $x) : FooImpl {
            // return type covariance - OK
            return new \TenantCloud\BetterReflection\Relocated\Levels\AcceptTypes\FooImpl();
        };
        $this->doBar($c);
        $this->doBaz($c);
        $c = function (\TenantCloud\BetterReflection\Relocated\Levels\AcceptTypes\FooInterface $x) use($parent) : ParentFooInterface {
    ...
    public function doFooUnionClosures(\TenantCloud\BetterReflection\Relocated\Levels\AcceptTypes\FooInterface $foo, \TenantCloud\BetterReflection\Relocated\Levels\AcceptTypes\ParentFooInterface $parent)
    {
     ...
     */
    public function doBar(\Closure $closure)
    {
    }
    /**
     * @param callable(FooInterface $x, int $y): FooInterface $callable
     */
    public function doBaz(callable $callable)
    {
    }
}
class Baz
{
    ...
    public function makeFoo() : \TenantCloud\BetterReflection\Relocated\Levels\AcceptTypes\Foo
    {
        return new \TenantCloud\BetterReflection\Relocated\Levels\AcceptTypes\Foo();
    }
    /**
     * @return Foo|mixed[]
     */
    ...
    private function requireFoo(\TenantCloud\BetterReflection\Relocated\Levels\AcceptTypes\Foo $foo)
    {
    }
}
class ArrayShapes
{
     ...
     */
    public function doFoo(array $callables, array $strings, array $integers, iterable $iterable)
    {
     ...
     */
    public function doBar(array $one)
    {
    }
}
...
class AcceptNonEmpty
{
     ...
     */
    public function doFoo(array $array, array $nonEmpty) : void
    {
        $this->doBar([]);
        $this->doBar([1, 2, 3]);
        $this->doBar($array);
     ...
     * @param non-empty-array<mixed> $nonEmpty
     */
    public function doBar(array $nonEmpty) : void
    {
    }
}
