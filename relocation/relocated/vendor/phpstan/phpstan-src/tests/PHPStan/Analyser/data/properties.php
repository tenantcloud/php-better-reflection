...
use TenantCloud\BetterReflection\Relocated\SomeGroupNamespace\One;
use TenantCloud\BetterReflection\Relocated\SomeGroupNamespace\Two as Too;
use TenantCloud\BetterReflection\Relocated\SomeGroupNamespace\Three;
/**
 * @property-read string $overriddenReadOnlyProperty
 * @property-read string $documentElement
 */
abstract class Foo extends \TenantCloud\BetterReflection\Relocated\PropertiesNamespace\Bar
{
