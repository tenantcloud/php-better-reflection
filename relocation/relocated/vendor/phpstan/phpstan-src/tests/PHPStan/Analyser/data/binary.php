...
namespace TenantCloud\BetterReflection\Relocated\BinaryOperations\NestedNamespace;
...
class Foo
{
    ...
    public function doFoo(array $generalArray)
    {
        ...
        $foo = new \TenantCloud\BetterReflection\Relocated\BinaryOperations\NestedNamespace\Foo();
        $one = 1;
        $array = [1, 2, 3];
        \reset($array);
        /** @var number $number */
