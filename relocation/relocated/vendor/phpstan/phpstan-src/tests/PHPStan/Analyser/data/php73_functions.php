...
namespace TenantCloud\BetterReflection\Relocated\Php73Functions;
...
class Foo
{
     ...
     */
    public function doFoo($mixed, int $integer, array $mixedArray, array $nonEmptyArray, array $arrayWithStringKeys)
    {
