 ...
 * @group exec
 */
class TraitsCachingIssueIntegrationTest extends \TenantCloud\BetterReflection\Relocated\PHPStan\Testing\TestCase
{
    /** @var string|null */
    ...
    {
        return [[\false, \false, []], [\false, \true, ['Method class@anonymous/TestClassUsingTrait.php:20::doBar() should return stdClass but returns Exception.']], [\true, \false, ['Method TraitsCachingIssue\\TestClassUsingTrait::doBar() should return stdClass but returns Exception.']], [\true, \true, ['Method TraitsCachingIssue\\TestClassUsingTrait::doBar() should return stdClass but returns Exception.', 'Method class@anonymous/TestClassUsingTrait.php:20::doBar() should return stdClass but returns Exception.']]];
    }
    /**
     ...
     */
    public function testCachingIssue(bool $changeOne, bool $changeTwo, array $expectedErrors) : void
    {
        $this->deleteCache();
    ...
    private function runPhpStan() : array
    {
        ...
        $json = \TenantCloud\BetterReflection\Relocated\Nette\Utils\Json::decode($stringOutput, \TenantCloud\BetterReflection\Relocated\Nette\Utils\Json::FORCE_ARRAY);
    ...
    private function deleteCache() : void
    {
        ...
        $files = new \RecursiveIteratorIterator(new \RecursiveDirectoryIterator(__DIR__ . '/tmp/cache', \RecursiveDirectoryIterator::SKIP_DOTS), \RecursiveIteratorIterator::CHILD_FIRST);
    ...
    {
        $originalTraitContents = \TenantCloud\BetterReflection\Relocated\PHPStan\File\FileReader::read($traitPath);
