...
namespace TenantCloud\BetterReflection\Relocated\InferPrivatePropertyTypeFromConstructor;
...
class Foo
{
     ...
     */
    public function __construct(string $intProp, string $stringProp, $unionProp, \stdClass $unrelatedDocComment, \stdClass $explicitMixed)
    {
