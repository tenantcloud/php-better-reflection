...
class AnalyserTraitsIntegrationTest extends \TenantCloud\BetterReflection\Relocated\PHPStan\Testing\TestCase
{
    /** @var \PHPStan\File\FileHelper */
    private $fileHelper;
    protected function setUp() : void
    {
        $this->fileHelper = self::getContainer()->getByType(\TenantCloud\BetterReflection\Relocated\PHPStan\File\FileHelper::class);
    }
    public function testMethodIsInClassUsingTrait() : void
    {
        $errors = $this->runAnalyse([__DIR__ . '/traits/Foo.php', __DIR__ . '/traits/FooTrait.php']);
        $this->assertEmpty($errors);
    }
    public function testMethodDoesNotExist() : void
    {
        $errors = $this->runAnalyse([__DIR__ . '/traits/Bar.php', __DIR__ . '/traits/FooTrait.php']);
        $this->assertCount(1, $errors);
        $error = $errors[0];
        $this->assertSame('Call to an undefined method AnalyseTraits\\Bar::doFoo().', $error->getMessage());
        $this->assertSame(\sprintf('%s (in context of class AnalyseTraits\\Bar)', $this->fileHelper->normalizePath(__DIR__ . '/traits/FooTrait.php')), $error->getFile());
        $this->assertSame(10, $error->getLine());
    }
    public function testNestedTraits() : void
    {
        $errors = $this->runAnalyse([__DIR__ . '/traits/NestedBar.php', __DIR__ . '/traits/NestedFooTrait.php', __DIR__ . '/traits/FooTrait.php']);
        ...
        $this->assertSame(\sprintf('%s (in context of class AnalyseTraits\\NestedBar)', $this->fileHelper->normalizePath(__DIR__ . '/traits/NestedFooTrait.php')), $secondError->getFile());
    ...
    {
        $errors = $this->runAnalyse([__DIR__ . '/traits/AnonymousClassUsingTrait.php', __DIR__ . '/traits/TraitWithTypeSpecification.php']);
        $this->assertCount(1, $errors);
    ...
    public function testWrongPropertyType() : void
    {
        ...
        $this->assertSame($this->fileHelper->normalizePath(__DIR__ . '/traits/wrongProperty/Foo.php'), $errors[0]->getFile());
        ...
        $this->assertSame($this->fileHelper->normalizePath(__DIR__ . '/traits/wrongProperty/Foo.php'), $errors[1]->getFile());
    ...
    {
        $errors = $this->runAnalyse([__DIR__ . '/traits/TraitWithAbstractMethod.php', __DIR__ . '/traits/ClassImplementingTraitWithAbstractMethod.php']);
        $this->assertCount(0, $errors);
    }
    /**
     * @param string[] $files
