...
namespace TenantCloud\BetterReflection\Relocated\SomeNodeScopeResolverNamespace;
...
class Foo
{
    public function doFoo($baz)
    {
        ...
        try {
            foo();
        } catch (\TenantCloud\BetterReflection\Relocated\SomeNodeScopeResolverNamespace\InvalidArgumentException $exception) {
            $lorem = 1;
