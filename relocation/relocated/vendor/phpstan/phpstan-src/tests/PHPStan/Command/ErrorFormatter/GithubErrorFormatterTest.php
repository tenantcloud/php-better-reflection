...
class GithubErrorFormatterTest extends \TenantCloud\BetterReflection\Relocated\PHPStan\Testing\ErrorFormatterTestCase
{
...
']);
    ...
    public function testFormatErrors(string $message, int $exitCode, int $numFileErrors, int $numGenericErrors, string $expected) : void
    {
        ...
        $formatter = new \TenantCloud\BetterReflection\Relocated\PHPStan\Command\ErrorFormatter\GithubErrorFormatter($relativePathHelper, new \TenantCloud\BetterReflection\Relocated\PHPStan\Command\ErrorFormatter\TableErrorFormatter($relativePathHelper, \false));
