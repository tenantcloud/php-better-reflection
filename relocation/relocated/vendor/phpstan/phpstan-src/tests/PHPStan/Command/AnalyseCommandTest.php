 ...
 * @group exec
 */
class AnalyseCommandTest extends \TenantCloud\BetterReflection\Relocated\PHPStan\Testing\TestCase
{
    /**
     * @param string $dir
     * @param string $file
    ...
    private function runCommand(int $expectedStatusCode, array $parameters = []) : string
    {
        ...
        $commandTester = new \TenantCloud\BetterReflection\Relocated\Symfony\Component\Console\Tester\CommandTester(new \TenantCloud\BetterReflection\Relocated\PHPStan\Command\AnalyseCommand([]));
