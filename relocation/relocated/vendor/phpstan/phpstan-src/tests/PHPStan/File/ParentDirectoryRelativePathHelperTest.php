...
class ParentDirectoryRelativePathHelperTest extends \TenantCloud\BetterReflection\Relocated\PHPUnit\Framework\TestCase
{
    ...
    {
        $helper = new \TenantCloud\BetterReflection\Relocated\PHPStan\File\ParentDirectoryRelativePathHelper($parentDirectory);
