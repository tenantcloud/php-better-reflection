...
php;
    $ruleErrorTypes = \TenantCloud\BetterReflection\Relocated\PHPStan\Rules\RuleErrorBuilder::getRuleErrorTypes();
    ...
    foreach (\range(1, $maxTypeNumber) as $typeCombination) {
        ...
        $phpClass = \sprintf($template, $typeCombination, \implode(', ', $interfaces), \implode("\n\n\t", \array_map(function (array $property) : string {
