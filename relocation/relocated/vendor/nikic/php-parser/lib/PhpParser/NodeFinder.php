...
use TenantCloud\BetterReflection\Relocated\PhpParser\NodeVisitor\FindingVisitor;
use TenantCloud\BetterReflection\Relocated\PhpParser\NodeVisitor\FirstFindingVisitor;
class NodeFinder
{
    /**
    ...
    public function find($nodes, callable $filter) : array
    {
        ...
        $visitor = new \TenantCloud\BetterReflection\Relocated\PhpParser\NodeVisitor\FindingVisitor($filter);
    ...
    public function findFirst($nodes, callable $filter)
    {
        ...
        $visitor = new \TenantCloud\BetterReflection\Relocated\PhpParser\NodeVisitor\FirstFindingVisitor($filter);
        $traverser = new \TenantCloud\BetterReflection\Relocated\PhpParser\NodeTraverser();
        $traverser->addVisitor($visitor);
        $traverser->traverse($nodes);
