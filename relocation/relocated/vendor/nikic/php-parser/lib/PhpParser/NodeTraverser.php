...
class NodeTraverser implements \TenantCloud\BetterReflection\Relocated\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    protected function traverseNode(\TenantCloud\BetterReflection\Relocated\PhpParser\Node $node) : \TenantCloud\BetterReflection\Relocated\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \TenantCloud\BetterReflection\Relocated\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \TenantCloud\BetterReflection\Relocated\PhpParser\Node) {
    ...
    {
        if ($old instanceof \TenantCloud\BetterReflection\Relocated\PhpParser\Node\Stmt && $new instanceof \TenantCloud\BetterReflection\Relocated\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \TenantCloud\BetterReflection\Relocated\PhpParser\Node\Expr && $new instanceof \TenantCloud\BetterReflection\Relocated\PhpParser\Node\Stmt) {
