...
class NullsafePropertyFetch extends \TenantCloud\BetterReflection\Relocated\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\TenantCloud\BetterReflection\Relocated\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
