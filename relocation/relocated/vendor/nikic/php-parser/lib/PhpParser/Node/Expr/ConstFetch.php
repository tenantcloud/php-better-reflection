...
class ConstFetch extends \TenantCloud\BetterReflection\Relocated\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\TenantCloud\BetterReflection\Relocated\PhpParser\Node\Name $name, array $attributes = [])
    {
