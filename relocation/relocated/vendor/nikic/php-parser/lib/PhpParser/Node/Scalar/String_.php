...
class String_ extends \TenantCloud\BetterReflection\Relocated\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \TenantCloud\BetterReflection\Relocated\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
