...
class StaticPropertyFetch extends \TenantCloud\BetterReflection\Relocated\PhpParser\Node\Expr
{
    ...
    public function __construct($class, $name, array $attributes = [])
    {
        ...
        $this->class = $class;
        $this->name = \is_string($name) ? new \TenantCloud\BetterReflection\Relocated\PhpParser\Node\VarLikeIdentifier($name) : $name;
    }
