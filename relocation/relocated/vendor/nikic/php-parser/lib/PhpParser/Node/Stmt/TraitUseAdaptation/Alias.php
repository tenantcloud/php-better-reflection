...
class Alias extends \TenantCloud\BetterReflection\Relocated\PhpParser\Node\Stmt\TraitUseAdaptation
{
    ...
    public function __construct($trait, $method, $newModifier, $newName, array $attributes = [])
    {
        ...
        $this->newName = \is_string($newName) ? new \TenantCloud\BetterReflection\Relocated\PhpParser\Node\Identifier($newName) : $newName;
    }
