...
class StreamEncryption
{
    ...
    private $method;
    private $server;
    public function __construct(\TenantCloud\BetterReflection\Relocated\React\EventLoop\LoopInterface $loop, $server = \true)
    {
        $this->loop = $loop;
        $this->server = $server;
    ...
    public function enable(\TenantCloud\BetterReflection\Relocated\React\Socket\Connection $stream)
    {
        return $this->toggle($stream, \true);
    }
    public function toggle(\TenantCloud\BetterReflection\Relocated\React\Socket\Connection $stream, $toggle)
    {
    ...
    public function toggleCrypto($socket, \TenantCloud\BetterReflection\Relocated\React\Promise\Deferred $deferred, $toggle, $method)
    {
        $error = null;
