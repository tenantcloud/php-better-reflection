 ...
 */
class LimitingServer extends \TenantCloud\BetterReflection\Relocated\Evenement\EventEmitter implements \TenantCloud\BetterReflection\Relocated\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\TenantCloud\BetterReflection\Relocated\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
    ...
    /** @internal */
    public function handleDisconnection(\TenantCloud\BetterReflection\Relocated\React\Socket\ConnectionInterface $connection)
    {
