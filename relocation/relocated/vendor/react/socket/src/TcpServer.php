 ...
 */
final class TcpServer extends \TenantCloud\BetterReflection\Relocated\Evenement\EventEmitter implements \TenantCloud\BetterReflection\Relocated\React\Socket\ServerInterface
{
    private $master;
    private $loop;
    ...
    {
        $this->emit('connection', array(new \TenantCloud\BetterReflection\Relocated\React\Socket\Connection($socket, $this->loop)));
    }
}
