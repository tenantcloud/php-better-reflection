 ...
 */
final class SecureServer extends \TenantCloud\BetterReflection\Relocated\Evenement\EventEmitter implements \TenantCloud\BetterReflection\Relocated\React\Socket\ServerInterface
{
    private $tcp;
    private $encryption;
    private $context;
     ...
     */
    public function __construct(\TenantCloud\BetterReflection\Relocated\React\Socket\ServerInterface $tcp, \TenantCloud\BetterReflection\Relocated\React\EventLoop\LoopInterface $loop, array $context)
    {
        ...
        $this->tcp = $tcp;
        $this->encryption = new \TenantCloud\BetterReflection\Relocated\React\Socket\StreamEncryption($loop);
    ...
    /** @internal */
    public function handleConnection(\TenantCloud\BetterReflection\Relocated\React\Socket\ConnectionInterface $connection)
    {
