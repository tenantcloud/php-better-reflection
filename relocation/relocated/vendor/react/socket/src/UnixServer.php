 ...
 */
final class UnixServer extends \TenantCloud\BetterReflection\Relocated\Evenement\EventEmitter implements \TenantCloud\BetterReflection\Relocated\React\Socket\ServerInterface
{
    private $master;
    private $loop;
     ...
     */
    public function __construct($path, \TenantCloud\BetterReflection\Relocated\React\EventLoop\LoopInterface $loop, array $context = array())
    {
        $this->loop = $loop;
    ...
    {
        $connection = new \TenantCloud\BetterReflection\Relocated\React\Socket\Connection($socket, $this->loop);
        $connection->unix = \true;
