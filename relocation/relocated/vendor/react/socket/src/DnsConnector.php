...
final class DnsConnector implements \TenantCloud\BetterReflection\Relocated\React\Socket\ConnectorInterface
{
    private $connector;
    private $resolver;
    public function __construct(\TenantCloud\BetterReflection\Relocated\React\Socket\ConnectorInterface $connector, \TenantCloud\BetterReflection\Relocated\React\Dns\Resolver\ResolverInterface $resolver)
    {
    ...
    public function connect($uri)
    {
        ...
        $resolved = null;
        return new \TenantCloud\BetterReflection\Relocated\React\Promise\Promise(function ($resolve, $reject) use(&$promise, &$resolved, $uri, $connector, $host, $parts) {
