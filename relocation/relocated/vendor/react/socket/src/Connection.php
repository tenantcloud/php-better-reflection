 ...
 * @internal
 */
class Connection extends \TenantCloud\BetterReflection\Relocated\Evenement\EventEmitter implements \TenantCloud\BetterReflection\Relocated\React\Socket\ConnectionInterface
{
    /**
    ...
    public $stream;
    private $input;
    public function __construct($resource, \TenantCloud\BetterReflection\Relocated\React\EventLoop\LoopInterface $loop)
    {
        ...
        $this->input = new \TenantCloud\BetterReflection\Relocated\React\Stream\DuplexResourceStream($resource, $loop, $clearCompleteBuffer ? -1 : null, new \TenantCloud\BetterReflection\Relocated\React\Stream\WritableResourceStream($resource, $loop, null, $limitWriteChunks ? 8192 : null));
        $this->stream = $resource;
        \TenantCloud\BetterReflection\Relocated\React\Stream\Util::forwardEvents($this->input, $this, array('data', 'end', 'error', 'close', 'pipe', 'drain'));
