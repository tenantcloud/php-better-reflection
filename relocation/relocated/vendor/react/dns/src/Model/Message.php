...
namespace TenantCloud\BetterReflection\Relocated\React\Dns\Model;
...
final class Message
{
     ...
     * @return self
     */
    public static function createRequestForQuery(\TenantCloud\BetterReflection\Relocated\React\Dns\Query\Query $query)
    {
        $request = new \TenantCloud\BetterReflection\Relocated\React\Dns\Model\Message();
     ...
     * @return self
     */
    public static function createResponseWithAnswersForQuery(\TenantCloud\BetterReflection\Relocated\React\Dns\Query\Query $query, array $answers)
    {
        $response = new \TenantCloud\BetterReflection\Relocated\React\Dns\Model\Message();
     ...
     * @see self::RCODE_OK
     */
    public $rcode = \TenantCloud\BetterReflection\Relocated\React\Dns\Model\Message::RCODE_OK;
    /**
