 ...
 * ```
 */
class SelectiveTransportExecutor implements \TenantCloud\BetterReflection\Relocated\React\Dns\Query\ExecutorInterface
{
    private $datagramExecutor;
    private $streamExecutor;
    public function __construct(\TenantCloud\BetterReflection\Relocated\React\Dns\Query\ExecutorInterface $datagramExecutor, \TenantCloud\BetterReflection\Relocated\React\Dns\Query\ExecutorInterface $streamExecutor)
    {
    ...
    public function query(\TenantCloud\BetterReflection\Relocated\React\Dns\Query\Query $query)
    {
        ...
        return new \TenantCloud\BetterReflection\Relocated\React\Promise\Promise(function ($resolve, $reject) use(&$pending, $stream, $query) {
