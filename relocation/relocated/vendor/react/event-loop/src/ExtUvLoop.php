 ...
 */
final class ExtUvLoop implements \TenantCloud\BetterReflection\Relocated\React\EventLoop\LoopInterface
{
    private $uv;
    ...
    public function addSignal($signal, $listener)
    {
        ...
        if (!isset($this->signalEvents[$signal])) {
            ...
            $this->signalEvents[$signal] = \TenantCloud\BetterReflection\Relocated\uv_signal_init($this->uv);
            \TenantCloud\BetterReflection\Relocated\uv_signal_start($this->signalEvents[$signal], function () use($signals, $signal) {
                $signals->call($signal);
            }, $signal);
        }
    }
    ...
    {
        if (!isset($this->streamEvents[(int) $stream])) {
            $this->streamEvents[(int) $stream] = \TenantCloud\BetterReflection\Relocated\uv_poll_init_socket($this->uv, $stream);
        }
