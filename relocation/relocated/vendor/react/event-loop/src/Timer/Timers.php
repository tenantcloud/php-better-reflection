...
namespace TenantCloud\BetterReflection\Relocated\React\EventLoop\Timer;
...
final class Timers
{
    ...
    public function add(\TenantCloud\BetterReflection\Relocated\React\EventLoop\TimerInterface $timer)
    {
    ...
    public function contains(\TenantCloud\BetterReflection\Relocated\React\EventLoop\TimerInterface $timer)
    {
        return isset($this->timers[\spl_object_hash($timer)]);
    }
    public function cancel(\TenantCloud\BetterReflection\Relocated\React\EventLoop\TimerInterface $timer)
    {
        $id = \spl_object_hash($timer);
