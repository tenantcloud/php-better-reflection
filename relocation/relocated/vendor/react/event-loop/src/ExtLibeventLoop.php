 ...
 */
final class ExtLibeventLoop implements \TenantCloud\BetterReflection\Relocated\React\EventLoop\LoopInterface
{
    /** @internal */
     ...
     */
    private function scheduleTimer(\TenantCloud\BetterReflection\Relocated\React\EventLoop\TimerInterface $timer)
    {
    ...
    private function createTimerCallback()
    {
        ...
        $this->timerCallback = function ($_, $__, $timer) use($timers, $that) {
            ...
            if ($timer->isPeriodic()) {
                \event_add($timers[$timer], $timer->getInterval() * \TenantCloud\BetterReflection\Relocated\React\EventLoop\ExtLibeventLoop::MICROSECONDS_PER_SECOND);
