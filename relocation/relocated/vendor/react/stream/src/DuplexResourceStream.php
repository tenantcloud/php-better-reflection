...
final class DuplexResourceStream extends \TenantCloud\BetterReflection\Relocated\Evenement\EventEmitter implements \TenantCloud\BetterReflection\Relocated\React\Stream\DuplexStreamInterface
{
    private $stream;
    private $loop;
    /**
    ...
    public function __construct($stream, \TenantCloud\BetterReflection\Relocated\React\EventLoop\LoopInterface $loop, $readChunkSize = null, \TenantCloud\BetterReflection\Relocated\React\Stream\WritableStreamInterface $buffer = null)
    {
        ...
        if ($buffer === null) {
            $buffer = new \TenantCloud\BetterReflection\Relocated\React\Stream\WritableResourceStream($stream, $loop);
        }
        $this->stream = $stream;
        $this->loop = $loop;
