...
use TenantCloud\BetterReflection\Relocated\RingCentral\Psr7\Response as Psr7Response;
 ...
 */
final class Response extends \TenantCloud\BetterReflection\Relocated\RingCentral\Psr7\Response
{
    /**
    ...
    public function __construct($status = 200, array $headers = array(), $body = '', $version = '1.1', $reason = null)
    {
        if ($body instanceof \TenantCloud\BetterReflection\Relocated\React\Stream\ReadableStreamInterface && !$body instanceof \TenantCloud\BetterReflection\Relocated\Psr\Http\Message\StreamInterface) {
            $body = new \TenantCloud\BetterReflection\Relocated\React\Http\Io\HttpBodyStream($body, null);
