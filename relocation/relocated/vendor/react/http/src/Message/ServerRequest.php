...
namespace TenantCloud\BetterReflection\Relocated\React\Http\Message;
 ...
 */
final class ServerRequest extends \TenantCloud\BetterReflection\Relocated\RingCentral\Psr7\Request implements \TenantCloud\BetterReflection\Relocated\Psr\Http\Message\ServerRequestInterface
{
    ...
    {
        $stream = null;
        if ($body instanceof \TenantCloud\BetterReflection\Relocated\React\Stream\ReadableStreamInterface && !$body instanceof \TenantCloud\BetterReflection\Relocated\Psr\Http\Message\StreamInterface) {
            $stream = $body;
            $body = null;
        } elseif (!\is_string($body) && !$body instanceof \TenantCloud\BetterReflection\Relocated\Psr\Http\Message\StreamInterface) {
        ...
        if ($stream !== null) {
            ...
            $this->stream = new \TenantCloud\BetterReflection\Relocated\React\Http\Io\HttpBodyStream($stream, $size);
        }
