...
final class MiddlewareRunner
{
     ...
     * @throws \Exception
     */
    public function __invoke(\TenantCloud\BetterReflection\Relocated\Psr\Http\Message\ServerRequestInterface $request)
    {
    ...
    /** @internal */
    public function call(\TenantCloud\BetterReflection\Relocated\Psr\Http\Message\ServerRequestInterface $request, $position)
    {
        ...
        $that = $this;
        $next = function (\TenantCloud\BetterReflection\Relocated\Psr\Http\Message\ServerRequestInterface $request) use($that, $position) {
